...
const recorderTranslations: Record<Language, {
    ...
    [Language.ZH]: {
        ...
        stop_recording: "停止录音",
        processing: "正在处理录音...",
        mic_denied: "麦克风访问被拒绝或不可用",
        processing_error: "处理录音时出错",
    },
    [Language.HI]: {
        record_dream: "सपना रिकॉर्ड करें",
        stop: "रोकें",
        start_recording: "रिकॉर्डिंग शुरू करें",
        stop_recording: "रिकॉर्डिंग बंद करें",
        processing: "रिकॉर्डिंग प्रोसेस हो रही है...",
        mic_denied: "माइक्रोफ़ोन एक्सेस अस्वीकृत या अनुपलब्ध",
        processing_error: "रिकॉर्डिंग प्रोसेसिंग में त्रुटि",
    },
    [Language.JA]: {
        record_dream: "夢を録音",
        stop: "停止",
        ...
        stop_recording: "録音停止",
        processing: "録音を処理中...",
        mic_denied: "マイクへのアクセスが拒否されたか利用できません",
    ...
    [Language.KO]: {
        ...
        processing: "녹음 처리 중...",
        mic_denied: "마이크 접근이 거부되었거나 사용할 수 없습니다",
        processing_error: "녹음 처리 중 오류 발생",
    },
    [Language.ID]: {
        record_dream: "Rekam Mimpi",
        stop: "Berhenti",
        ...
        processing_error: "Gagal memproses rekaman",
    },
    [Language.FA]: {
        record_dream: "ضبط خواب",
        stop: "توقف",
        start_recording: "شروع ضبط",
        stop_recording: "پایان ضبط",
        processing: "در حال پردازش ضبط...",
        mic_denied: "دسترسی به میکروفون رد شد یا در دسترس نیست",
        processing_error: "خطا در پردازش ضبط",
    },
    [Language.IT]: {
        record_dream: "Registra Sogno",
        stop: "Stop",
        start_recording: "Avvia Registrazione",
        stop_recording: "Ferma Registrazione",
        processing: "Elaborazione registrazione...",
        mic_denied: "Accesso al microfono negato o non disponibile",
        processing_error: "Errore nell'elaborazione della registrazione",
    },
    [Language.PL]: {
        record_dream: "Nagraj Sen",
        stop: "Stop",
        start_recording: "Rozpocznij Nagrywanie",
        stop_recording: "Zatrzymaj Nagrywanie",
        processing: "Przetwarzanie nagrania...",
        mic_denied: "Dostęp do mikrofonu odrzucony lub niedostępny",
        processing_error: "Błąd przetwarzania nagrania",
    },
    [Language.BN]: {
        record_dream: "স্বপ্ন রেকর্ড করুন",
        stop: "থামুন",
        start_recording: "রেকর্ডিং শুরু করুন",
        stop_recording: "রেকর্ডিং বন্ধ করুন",
        processing: "রেকর্ডিং প্রক্রিয়াকরণ...",
        mic_denied: "মাইক্রোফোন অ্যাক্সেস প্রত্যাখ্যান বা অনুপলব্ধ",
        processing_error: "রেকর্ডিং প্রক্রিয়াকরণে ত্রুটি",
    },
    [Language.UR]: {
        record_dream: "خواب ریکارڈ کریں",
        stop: "رکیں",
        start_recording: "ریکارڈنگ شروع کریں",
        stop_recording: "ریکارڈنگ بند کریں",
        processing: "ریکارڈنگ پروسیس ہو رہی ہے...",
        mic_denied: "مائیکروفون تک رسائی مسترد یا دستیاب نہیں",
        processing_error: "ریکارڈنگ پروسیسنگ میں خرابی",
    },
    [Language.VI]: {
        record_dream: "Ghi âm Giấc mơ",
        stop: "Dừng",
        start_recording: "Bắt đầu Ghi âm",
        stop_recording: "Dừng Ghi âm",
        processing: "Đang xử lý bản ghi...",
        mic_denied: "Quyền truy cập micro bị từ chối hoặc không khả dụng",
        processing_error: "Lỗi khi xử lý bản ghi",
    },
    [Language.TH]: {
        record_dream: "บันทึกความฝัน",
        stop: "หยุด",
        start_recording: "เริ่มบันทึก",
        stop_recording: "หยุดบันทึก",
        processing: "กำลังประมวลผลการบันทึก...",
        mic_denied: "การเข้าถึงไมโครโฟนถูกปฏิเสธหรือไม่พร้อมใช้งาน",
        processing_error: "เกิดข้อผิดพลาดในการประมวลผลการบันทึก",
    },
    [Language.SW]: {
        record_dream: "Rekodi Ndoto",
        stop: "Simama",
        start_recording: "Anza Kurekodi",
        stop_recording: "Simamisha Kurekodi",
        processing: "Inachakata rekodi...",
        mic_denied: "Ufikiaji wa kipaza sauti umekataliwa au haupatikani",
        processing_error: "Hitilafu katika kuchakata rekodi",
    },
    [Language.HU]: {
        record_dream: "Álom felvétele",
        stop: "Leállítás",
        start_recording: "Felvétel indítása",
        stop_recording: "Felvétel leállítása",
        processing: "Felvétel feldolgozása...",
        mic_denied: "Mikrofon-hozzáférés megtagadva vagy nem elérhető",
        processing_error: "Hiba a felvétel feldolgozásakor",
    },
};

...
const SCIENCE_TRANSLATIONS: Record<Language, {
  ...
  [Language.TA]: {
    back: 'பின்செல்',
    title: 'அறிவியல்',
    hero_title: 'DreamCode-ன் அறிவியல் அடிப்படை',
    hero_subtitle: 'எங்கள் கனவு விளக்கங்கள் உலகின் மிகப்பெரிய டிஜிட்டல் கனவு அறிக்கைகளின் தொகுப்பை அடிப்படையாகக் கொண்டவை',
    counter_label: 'அறிவியல் கனவு அறிக்கைகள் பகுப்பாய்வு செய்யப்பட்டன',
    sources_title: 'எங்கள் ஆராய்ச்சி தரவுத்தளங்கள்',
    sddb_name: 'தூக்கம் மற்றும் கனவு தரவுத்தளம் (SDDb)',
    sddb_count: '24,000+ கனவு அறிக்கைகள்',
    sddb_desc: 'அறிவியல் ரீதியாக குறியிடப்பட்ட கனவு அறிக்கைகளின் மிக விரிவான தொகுப்பு',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad களஞ்சியம்',
    dreambank_count: '15,000+ கனவு அறிக்கைகள்',
    dreambank_desc: 'ஹால்-வான் டி கேசில் குறியிடல் முறையின்படி சிறுகுறிப்பு செய்யப்பட்டவை',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM தரவுத்தளம் (மோனாஷ் பல்கலைக்கழகம்)',
    dream_db_count: 'தொடர்ந்து விரிவாகிறது',
    dream_db_desc: 'ஆஸ்திரேலியாவிலிருந்து கல்வி சார்ந்த கனவு ஆராய்ச்சி',
    method_title: 'எங்கள் பகுப்பாய்வு எவ்வாறு செயல்படுகிறது',
    step1_title: 'படி 1: உட்பொதிப்பு',
    step1_desc: 'உங்கள் கனவு கணித பிரதிநிதித்துவமாக (embedding) மாற்றப்படுகிறது',
    step2_title: 'படி 2: வடிவமைப்பு தேடல்',
    step2_desc: '39,075+ அறிவியல் அறிக்கைகளில் ஒத்த வடிவமைப்புகளைத் தேடுகிறோம்',
    step3_title: 'படி 3: விளக்கம்',
    step3_desc: 'AI சிறந்த பொருத்தங்களின் அடிப்படையில் தனிப்பயன் விளக்கத்தை உருவாக்குகிறது',
    hvcs_title: 'ஹால்-வான் டி கேசில் முறை',
    hvcs_desc: 'கனவு உள்ளடக்கத்திற்கான உலகளவில் அங்கீகரிக்கப்பட்ட குறியிடல் முறை',
    hvcs_cat_title: 'வகைகள்:',
    hvcs_cats: ['உணர்வுகள்', 'கதாபாத்திரங்கள்', 'தொடர்புகள்', 'சூழல்கள்'],
    hvcs_since: '1966-ல் உருவாக்கப்பட்டது · கனவு ஆராய்ச்சியில் தரநிலை',
    researcher_title: 'ஆராய்ச்சியாளர்களுக்கு',
    api_title: 'ஆராய்ச்சி API (விரைவில்)',
    api_desc: 'கல்வி ஆராய்ச்சிக்காக ஒருங்கிணைக்கப்பட்ட கனவு தரவுக்கான அநாமதேய அணுகல்',
    api_badge: 'பீட்டா Q2 2026',
    refs_title: 'அறிவியல் குறிப்புகள்',
    cta_title: 'உங்கள் கனவை விளக்க தயாரா?',
    cta_btn: 'இப்போது கனவை உள்ளிடுங்கள்',
  },
  [Language.TE]: {
    back: 'వెనుకకు',
    title: 'సైన్స్',
    hero_title: 'DreamCode యొక్క శాస్త్రీయ ఆధారం',
    hero_subtitle: 'మా కల వ్యాఖ్యానాలు ప్రపంచంలోని అతిపెద్ద డిజిటల్ కల నివేదికల సేకరణపై ఆధారపడి ఉన్నాయి',
    counter_label: 'శాస్త్రీయ కల నివేదికలు విశ్లేషించబడ్డాయి',
    sources_title: 'మా పరిశోధన డేటాబేస్‌లు',
    sddb_name: 'నిద్ర మరియు కల డేటాబేస్ (SDDb)',
    sddb_count: '24,000+ కల నివేదికలు',
    sddb_desc: 'శాస్త్రీయంగా కోడ్ చేయబడిన కల నివేదికల అత్యంత సమగ్ర సేకరణ',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad రిపోజిటరీ',
    dreambank_count: '15,000+ కల నివేదికలు',
    dreambank_desc: 'హాల్-వాన్ డి కాసిల్ కోడింగ్ వ్యవస్థ ప్రకారం ఉల్లేఖించబడినవి',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM డేటాబేస్ (మోనాష్ విశ్వవిద్యాలయం)',
    dream_db_count: 'నిరంతర విస్తరణ',
    dream_db_desc: 'ఆస్ట్రేలియా నుండి విద్యా సంబంధిత కల పరిశోధన',
    method_title: 'మా విశ్లేషణ ఎలా పని చేస్తుంది',
    step1_title: 'దశ 1: ఎంబెడ్డింగ్',
    step1_desc: 'మీ కల గణిత ప్రాతినిధ్యంగా (embedding) మార్చబడుతుంది',
    step2_title: 'దశ 2: నమూనా శోధన',
    step2_desc: '39,075+ శాస్త్రీయ నివేదికలలో సారూప్య నమూనాలను శోధిస్తాము',
    step3_title: 'దశ 3: వ్యాఖ్యానం',
    step3_desc: 'AI ఉత్తమ సరిపోలికల ఆధారంగా వ్యక్తిగతీకరించిన వ్యాఖ్యానాన్ని సృష్టిస్తుంది',
    hvcs_title: 'హాల్-వాన్ డి కాసిల్ వ్యవస్థ',
    hvcs_desc: 'కల కంటెంట్ కోసం ప్రపంచవ్యాప్తంగా గుర్తించబడిన కోడింగ్ వ్యవస్థ',
    hvcs_cat_title: 'వర్గాలు:',
    hvcs_cats: ['భావోద్వేగాలు', 'పాత్రలు', 'పరస్పర చర్యలు', 'వాతావరణాలు'],
    hvcs_since: '1966లో అభివృద్ధి చేయబడింది · కల పరిశోధనలో ప్రమాణం',
    researcher_title: 'పరిశోధకుల కోసం',
    api_title: 'పరిశోధన API (త్వరలో)',
    api_desc: 'విద్యా పరిశోధన కోసం సమగ్ర కల డేటాకు అనామక ప్రాప్యత',
    api_badge: 'బీటా Q2 2026',
    refs_title: 'శాస్త్రీయ సూచనలు',
    cta_title: 'మీ కలను వ్యాఖ్యానించడానికి సిద్ధంగా ఉన్నారా?',
    cta_btn: 'ఇప్పుడు కలను నమోదు చేయండి',
  },
  [Language.TL]: {
    back: 'Bumalik',
    title: 'Agham',
    hero_title: 'Ang siyentipikong pundasyon ng DreamCode',
    hero_subtitle: 'Ang aming mga interpretasyon ng panaginip ay batay sa pinakamalaking digital na koleksyon ng mga ulat ng panaginip sa buong mundo',
    counter_label: 'siyentipikong ulat ng panaginip ang nasuri',
    sources_title: 'Ang Aming Mga Database ng Pananaliksik',
    sddb_name: 'Sleep and Dream Database (SDDb)',
    sddb_count: '24,000+ ulat ng panaginip',
    sddb_desc: 'Ang pinakamalawak na koleksyon ng siyentipikong naka-code na mga ulat ng panaginip',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad Repository',
    dreambank_count: '15,000+ ulat ng panaginip',
    dreambank_desc: 'Naka-annotate ayon sa Hall-Van de Castle coding system',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM Database (Monash University)',
    dream_db_count: 'Patuloy na pagpapalawak',
    dream_db_desc: 'Akademikong pananaliksik sa panaginip mula sa Australia',
    method_title: 'Paano gumagana ang aming pagsusuri',
    step1_title: 'Hakbang 1: Embedding',
    step1_desc: 'Ang iyong panaginip ay kino-convert sa isang mathematical representation (embedding)',
    step2_title: 'Hakbang 2: Paghahanap ng pattern',
    step2_desc: 'Naghahanap kami ng katulad na mga pattern sa 39,075+ siyentipikong ulat',
    step3_title: 'Hakbang 3: Interpretasyon',
    step3_desc: 'Gumagawa ang AI ng personalized na interpretasyon batay sa pinakamahusay na mga tugma',
    hvcs_title: 'Hall-Van de Castle System',
    hvcs_desc: 'Ang pandaigdigang kinikilalang coding system para sa nilalaman ng panaginip',
    hvcs_cat_title: 'Mga Kategorya:',
    hvcs_cats: ['Emosyon', 'Mga Karakter', 'Interaksyon', 'Kapaligiran'],
    hvcs_since: 'Binuo noong 1966 · Pamantayan sa pananaliksik sa panaginip',
    researcher_title: 'Para sa mga Mananaliksik',
    api_title: 'Research API (Malapit Na)',
    api_desc: 'Anonymous na access sa pinagsama-samang data ng panaginip para sa akademikong pananaliksik',
    api_badge: 'Beta Q2 2026',
    refs_title: 'Mga Siyentipikong Sanggunian',
    cta_title: 'Handa ka na bang i-interpret ang iyong panaginip?',
    cta_btn: 'Ilagay ang panaginip ngayon',
  },
  [Language.ML]: {
    back: 'തിരികെ',
    title: 'ശാസ്ത്രം',
    hero_title: 'DreamCode-ന്റെ ശാസ്ത്രീയ അടിത്തറ',
    hero_subtitle: 'ഞങ്ങളുടെ സ്വപ്ന വ്യാഖ്യാനങ്ങൾ ലോകത്തിലെ ഏറ്റവും വലിയ ഡിജിറ്റൽ സ്വപ്ന റിപ്പോർട്ട് ശേഖരത്തെ അടിസ്ഥാനമാക്കിയുള്ളതാണ്',
    counter_label: 'ശാസ്ത്രീയ സ്വപ്ന റിപ്പോർട്ടുകൾ വിശകലനം ചെയ്തു',
    sources_title: 'ഞങ്ങളുടെ ഗവേഷണ ഡാറ്റാബേസുകൾ',
    sddb_name: 'ഉറക്കവും സ്വപ്നവും ഡാറ്റാബേസ് (SDDb)',
    sddb_count: '24,000+ സ്വപ്ന റിപ്പോർട്ടുകൾ',
    sddb_desc: 'ശാസ്ത്രീയമായി കോഡ് ചെയ്ത സ്വപ്ന റിപ്പോർട്ടുകളുടെ ഏറ്റവും സമഗ്രമായ ശേഖരം',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad റിപ്പോസിറ്ററി',
    dreambank_count: '15,000+ സ്വപ്ന റിപ്പോർട്ടുകൾ',
    dreambank_desc: 'ഹാൾ-വാൻ ഡി കാസിൽ കോഡിംഗ് സിസ്റ്റം അനുസരിച്ച് വ്യാഖ്യാനിച്ചത്',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM ഡാറ്റാബേസ് (മൊണാഷ് സർവകലാശാല)',
    dream_db_count: 'തുടർച്ചയായ വിപുലീകരണം',
    dream_db_desc: 'ഓസ്ട്രേലിയയിൽ നിന്നുള്ള അക്കാദമിക് സ്വപ്ന ഗവേഷണം',
    method_title: 'ഞങ്ങളുടെ വിശകലനം എങ്ങനെ പ്രവർത്തിക്കുന്നു',
    step1_title: 'ഘട്ടം 1: എംബെഡ്ഡിംഗ്',
    step1_desc: 'നിങ്ങളുടെ സ്വപ്നം ഗണിതശാസ്ത്ര പ്രതിനിധാനമായി (embedding) പരിവർത്തനം ചെയ്യുന്നു',
    step2_title: 'ഘട്ടം 2: പാറ്റേൺ തിരയൽ',
    step2_desc: '39,075+ ശാസ്ത്രീയ റിപ്പോർട്ടുകളിൽ സമാന പാറ്റേണുകൾ തിരയുന്നു',
    step3_title: 'ഘട്ടം 3: വ്യാഖ്യാനം',
    step3_desc: 'ഏറ്റവും മികച്ച പൊരുത്തങ്ങളെ അടിസ്ഥാനമാക്കി AI വ്യക്തിഗതമാക്കിയ വ്യാഖ്യാനം സൃഷ്ടിക്കുന്നു',
    hvcs_title: 'ഹാൾ-വാൻ ഡി കാസിൽ സിസ്റ്റം',
    hvcs_desc: 'സ്വപ്ന ഉള്ളടക്കത്തിനായി ആഗോളതലത്തിൽ അംഗീകരിക്കപ്പെട്ട കോഡിംഗ് സിസ്റ്റം',
    hvcs_cat_title: 'വിഭാഗങ്ങൾ:',
    hvcs_cats: ['വികാരങ്ങൾ', 'കഥാപാത്രങ്ങൾ', 'ഇടപെടലുകൾ', 'പരിസ്ഥിതികൾ'],
    hvcs_since: '1966-ൽ വികസിപ്പിച്ചത് · സ്വപ്ന ഗവേഷണത്തിലെ മാനദണ്ഡം',
    researcher_title: 'ഗവേഷകർക്ക്',
    api_title: 'ഗവേഷണ API (ഉടൻ വരുന്നു)',
    api_desc: 'അക്കാദമിക് ഗവേഷണത്തിനായി സമാഹരിച്ച സ്വപ്ന ഡാറ്റയിലേക്ക് അജ്ഞാത ആക്സസ്',
    api_badge: 'ബീറ്റ Q2 2026',
    refs_title: 'ശാസ്ത്രീയ റഫറൻസുകൾ',
    cta_title: 'നിങ്ങളുടെ സ്വപ്നം വ്യാഖ്യാനിക്കാൻ തയ്യാറാണോ?',
    cta_btn: 'ഇപ്പോൾ സ്വപ്നം നൽകുക',
  },
  [Language.MR]: {
    back: 'मागे',
    title: 'विज्ञान',
    hero_title: 'DreamCode चा वैज्ञानिक आधार',
    hero_subtitle: 'आमचे स्वप्न अर्थ जगातील सर्वात मोठ्या डिजिटल स्वप्न अहवाल संग्रहावर आधारित आहेत',
    counter_label: 'वैज्ञानिक स्वप्न अहवालांचे विश्लेषण',
    sources_title: 'आमचे संशोधन डेटाबेस',
    sddb_name: 'स्लीप अँड ड्रीम डेटाबेस (SDDb)',
    sddb_count: '24,000+ स्वप्न अहवाल',
    sddb_desc: 'वैज्ञानिकदृष्ट्या कोड केलेल्या स्वप्न अहवालांचा सर्वात व्यापक संग्रह',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad भांडार',
    dreambank_count: '15,000+ स्वप्न अहवाल',
    dreambank_desc: 'हॉल-व्हॅन डी कॅसल कोडिंग प्रणालीनुसार भाष्य केलेले',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM डेटाबेस (मोनाश विद्यापीठ)',
    dream_db_count: 'सतत विस्तार',
    dream_db_desc: 'ऑस्ट्रेलियातील शैक्षणिक स्वप्न संशोधन',
    method_title: 'आमचे विश्लेषण कसे कार्य करते',
    step1_title: 'पायरी 1: एम्बेडिंग',
    step1_desc: 'तुमचे स्वप्न गणितीय प्रतिनिधित्वात (embedding) रूपांतरित केले जाते',
    step2_title: 'पायरी 2: पॅटर्न शोध',
    step2_desc: '39,075+ वैज्ञानिक अहवालांमध्ये समान पॅटर्न शोधतो',
    step3_title: 'पायरी 3: अर्थ',
    step3_desc: 'AI सर्वोत्तम जुळणीच्या आधारे वैयक्तिक अर्थ तयार करते',
    hvcs_title: 'हॉल-व्हॅन डी कॅसल प्रणाली',
    hvcs_desc: 'स्वप्न सामग्रीसाठी जागतिक स्तरावर मान्यताप्राप्त कोडिंग प्रणाली',
    hvcs_cat_title: 'श्रेण्या:',
    hvcs_cats: ['भावना', 'पात्रे', 'परस्परक्रिया', 'वातावरण'],
    hvcs_since: '1966 मध्ये विकसित · स्वप्न संशोधनातील मानक',
    researcher_title: 'संशोधकांसाठी',
    api_title: 'संशोधन API (लवकरच)',
    api_desc: 'शैक्षणिक संशोधनासाठी एकत्रित स्वप्न डेटामध्ये अनामित प्रवेश',
    api_badge: 'बीटा Q2 2026',
    refs_title: 'वैज्ञानिक संदर्भ',
    cta_title: 'तुमच्या स्वप्नाचा अर्थ लावण्यास तयार आहात?',
    cta_btn: 'आता स्वप्न प्रविष्ट करा',
  },
  [Language.KN]: {
    back: 'ಹಿಂದಕ್ಕೆ',
    title: 'ವಿಜ್ಞಾನ',
    hero_title: 'DreamCode ನ ವೈಜ್ಞಾನಿಕ ಅಡಿಪಾಯ',
    hero_subtitle: 'ನಮ್ಮ ಕನಸಿನ ವ್ಯಾಖ್ಯಾನಗಳು ಜಗತ್ತಿನ ಅತಿದೊಡ್ಡ ಡಿಜಿಟಲ್ ಕನಸಿನ ವರದಿಗಳ ಸಂಗ್ರಹವನ್ನು ಆಧರಿಸಿವೆ',
    counter_label: 'ವೈಜ್ಞಾನಿಕ ಕನಸಿನ ವರದಿಗಳು ವಿಶ್ಲೇಷಿಸಲಾಗಿದೆ',
    sources_title: 'ನಮ್ಮ ಸಂಶೋಧನೆ ಡೇಟಾಬೇಸ್‌ಗಳು',
    sddb_name: 'ನಿದ್ರೆ ಮತ್ತು ಕನಸಿನ ಡೇಟಾಬೇಸ್ (SDDb)',
    sddb_count: '24,000+ ಕನಸಿನ ವರದಿಗಳು',
    sddb_desc: 'ವೈಜ್ಞಾನಿಕವಾಗಿ ಕೋಡ್ ಮಾಡಲಾದ ಕನಸಿನ ವರದಿಗಳ ಅತ್ಯಂತ ಸಮಗ್ರ ಸಂಗ್ರಹ',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad ರೆಪೊಸಿಟರಿ',
    dreambank_count: '15,000+ ಕನಸಿನ ವರದಿಗಳು',
    dreambank_desc: 'ಹಾಲ್-ವ್ಯಾನ್ ಡಿ ಕ್ಯಾಸಲ್ ಕೋಡಿಂಗ್ ವ್ಯವಸ್ಥೆಯ ಪ್ರಕಾರ ಟಿಪ್ಪಣಿ ಮಾಡಲಾಗಿದೆ',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM ಡೇಟಾಬೇಸ್ (ಮೊನಾಷ್ ವಿಶ್ವವಿದ್ಯಾಲಯ)',
    dream_db_count: 'ನಿರಂತರ ವಿಸ್ತರಣೆ',
    dream_db_desc: 'ಆಸ್ಟ್ರೇಲಿಯಾದಿಂದ ಶೈಕ್ಷಣಿಕ ಕನಸಿನ ಸಂಶೋಧನೆ',
    method_title: 'ನಮ್ಮ ವಿಶ್ಲೇಷಣೆ ಹೇಗೆ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ',
    step1_title: 'ಹಂತ 1: ಎಂಬೆಡ್ಡಿಂಗ್',
    step1_desc: 'ನಿಮ್ಮ ಕನಸನ್ನು ಗಣಿತಶಾಸ್ತ್ರೀಯ ಪ್ರಾತಿನಿಧ್ಯವಾಗಿ (embedding) ಪರಿವರ್ತಿಸಲಾಗುತ್ತದೆ',
    step2_title: 'ಹಂತ 2: ಮಾದರಿ ಹುಡುಕಾಟ',
    step2_desc: '39,075+ ವೈಜ್ಞಾನಿಕ ವರದಿಗಳಲ್ಲಿ ಸಮಾನ ಮಾದರಿಗಳನ್ನು ಹುಡುಕುತ್ತೇವೆ',
    step3_title: 'ಹಂತ 3: ವ್ಯಾಖ್ಯಾನ',
    step3_desc: 'ಅತ್ಯುತ್ತಮ ಹೊಂದಾಣಿಕೆಗಳ ಆಧಾರದ ಮೇಲೆ AI ವೈಯಕ್ತಿಕ ವ್ಯಾಖ್ಯಾನವನ್ನು ರಚಿಸುತ್ತದೆ',
    hvcs_title: 'ಹಾಲ್-ವ್ಯಾನ್ ಡಿ ಕ್ಯಾಸಲ್ ವ್ಯವಸ್ಥೆ',
    hvcs_desc: 'ಕನಸಿನ ವಿಷಯಕ್ಕಾಗಿ ಜಾಗತಿಕವಾಗಿ ಗುರುತಿಸಲ್ಪಟ್ಟ ಕೋಡಿಂಗ್ ವ್ಯವಸ್ಥೆ',
    hvcs_cat_title: 'ವರ್ಗಗಳು:',
    hvcs_cats: ['ಭಾವನೆಗಳು', 'ಪಾತ್ರಗಳು', 'ಪರಸ್ಪರ ಕ್ರಿಯೆಗಳು', 'ಪರಿಸರಗಳು'],
    hvcs_since: '1966 ರಲ್ಲಿ ಅಭಿವೃದ್ಧಿಪಡಿಸಲಾಯಿತು · ಕನಸಿನ ಸಂಶೋಧನೆಯಲ್ಲಿ ಮಾನದಂಡ',
    researcher_title: 'ಸಂಶೋಧಕರಿಗೆ',
    api_title: 'ಸಂಶೋಧನೆ API (ಶೀಘ್ರದಲ್ಲಿ)',
    api_desc: 'ಶೈಕ್ಷಣಿಕ ಸಂಶೋಧನೆಗಾಗಿ ಸಮಗ್ರ ಕನಸಿನ ಡೇಟಾಗೆ ಅನಾಮಧೇಯ ಪ್ರವೇಶ',
    api_badge: 'ಬೀಟಾ Q2 2026',
    refs_title: 'ವೈಜ್ಞಾನಿಕ ಉಲ್ಲೇಖಗಳು',
    cta_title: 'ನಿಮ್ಮ ಕನಸನ್ನು ವ್ಯಾಖ್ಯಾನಿಸಲು ಸಿದ್ಧರಿದ್ದೀರಾ?',
    cta_btn: 'ಈಗ ಕನಸನ್ನು ನಮೂದಿಸಿ',
  },
  [Language.GU]: {
    back: 'પાછા',
    title: 'વિજ્ઞાન',
    hero_title: 'DreamCode નો વૈજ્ઞાનિક આધાર',
    hero_subtitle: 'અમારા સ્વપ્ન અર્થઘટન વિશ્વના સૌથી મોટા ડિજિટલ સ્વપ્ન અહેવાલ સંગ્રહ પર આધારિત છે',
    counter_label: 'વૈજ્ઞાનિક સ્વપ્ન અહેવાલોનું વિશ્લેષણ',
    sources_title: 'અમારા સંશોધન ડેટાબેઝ',
    sddb_name: 'સ્લીપ એન્ડ ડ્રીમ ડેટાબેઝ (SDDb)',
    sddb_count: '24,000+ સ્વપ્ન અહેવાલ',
    sddb_desc: 'વૈજ્ઞાનિક રીતે કોડ કરેલા સ્વપ્ન અહેવાલોનો સૌથી વ્યાપક સંગ્રહ',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad ભંડાર',
    dreambank_count: '15,000+ સ્વપ્ન અહેવાલ',
    dreambank_desc: 'હોલ-વાન ડી કેસલ કોડિંગ સિસ્ટમ અનુસાર ટીકા કરેલ',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM ડેટાબેઝ (મોનાશ યુનિવર્સિટી)',
    dream_db_count: 'સતત વિસ્તરણ',
    dream_db_desc: 'ઓસ્ટ્રેલિયાથી શૈક્ષણિક સ્વપ્ન સંશોધન',
    method_title: 'અમારું વિશ્લેષણ કેવી રીતે કામ કરે છે',
    step1_title: 'પગલું 1: એમ્બેડિંગ',
    step1_desc: 'તમારા સ્વપ્નને ગાણિતિક પ્રતિનિધિત્વમાં (embedding) રૂપાંતરિત કરવામાં આવે છે',
    step2_title: 'પગલું 2: પેટર્ન શોધ',
    step2_desc: '39,075+ વૈજ્ઞાનિક અહેવાલોમાં સમાન પેટર્ન શોધીએ છીએ',
    step3_title: 'પગલું 3: અર્થઘટન',
    step3_desc: 'AI શ્રેષ્ઠ મેળખાવ પર આધારિત વ્યક્તિગત અર્થઘટન બનાવે છે',
    hvcs_title: 'હોલ-વાન ડી કેસલ સિસ્ટમ',
    hvcs_desc: 'સ્વપ્ન સામગ્રી માટે વૈશ્વિક સ્તરે માન્યતા પ્રાપ્ત કોડિંગ સિસ્ટમ',
    hvcs_cat_title: 'શ્રેણીઓ:',
    hvcs_cats: ['લાગણીઓ', 'પાત્રો', 'ક્રિયાપ્રતિક્રિયાઓ', 'વાતાવરણ'],
    hvcs_since: '1966 માં વિકસિત · સ્વપ્ન સંશોધનમાં ધોરણ',
    researcher_title: 'સંશોધકો માટે',
    api_title: 'સંશોધન API (ટૂંક સમયમાં)',
    api_desc: 'શૈક્ષણિક સંશોધન માટે એકત્રિત સ્વપ્ન ડેટામાં અનામી ઍક્સેસ',
    api_badge: 'બીટા Q2 2026',
    refs_title: 'વૈજ્ઞાનિક સંદર્ભો',
    cta_title: 'તમારા સ્વપ્નનું અર્થઘટન કરવા તૈયાર છો?',
    cta_btn: 'હવે સ્વપ્ન દાખલ કરો',
  },
  [Language.HE]: {
    back: 'חזרה',
    title: 'מדע',
    hero_title: 'הבסיס המדעי של DreamCode',
    hero_subtitle: 'פירושי החלומות שלנו מבוססים על האוסף הדיגיטלי הגדול בעולם של דוחות חלומות',
    counter_label: 'דוחות חלומות מדעיים נותחו',
    sources_title: 'מאגרי המחקר שלנו',
    sddb_name: 'מאגר השינה והחלומות (SDDb)',
    sddb_count: '24,000+ דוחות חלומות',
    sddb_desc: 'האוסף המקיף ביותר של דוחות חלומות מקודדים מדעית',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / מאגר Dryad',
    dreambank_count: '15,000+ דוחות חלומות',
    dreambank_desc: 'מסומנים לפי מערכת הקידוד של הול-ואן דה קאסל',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'מאגר DREAM (אוניברסיטת מונאש)',
    dream_db_count: 'הרחבה מתמשכת',
    dream_db_desc: 'מחקר חלומות אקדמי מאוסטרליה',
    method_title: 'כיצד הניתוח שלנו עובד',
    step1_title: 'שלב 1: הטמעה',
    step1_desc: 'החלום שלך מומר לייצוג מתמטי (embedding)',
    step2_title: 'שלב 2: חיפוש דפוסים',
    step2_desc: 'אנו מחפשים דפוסים דומים ב-39,075+ דוחות מדעיים',
    step3_title: 'שלב 3: פירוש',
    step3_desc: 'הבינה המלאכותית יוצרת פירוש מותאם אישית על בסיס ההתאמות הטובות ביותר',
    hvcs_title: 'מערכת הול-ואן דה קאסל',
    hvcs_desc: 'מערכת הקידוד המוכרת בעולם לתוכן חלומות',
    hvcs_cat_title: 'קטגוריות:',
    hvcs_cats: ['רגשות', 'דמויות', 'אינטראקציות', 'סביבות'],
    hvcs_since: 'פותחה ב-1966 · תקן במחקר חלומות',
    researcher_title: 'לחוקרים',
    api_title: 'API מחקרי (בקרוב)',
    api_desc: 'גישה אנונימית לנתוני חלומות מצטברים למחקר אקדמי',
    api_badge: 'בטא Q2 2026',
    refs_title: 'מקורות מדעיים',
    cta_title: 'מוכנים לפרש את החלום שלכם?',
    cta_btn: 'הזינו חלום עכשיו',
  },
  [Language.NE]: {
    back: 'पछाडि',
    title: 'विज्ञान',
    hero_title: 'DreamCode को वैज्ञानिक आधार',
    hero_subtitle: 'हाम्रा सपनाका व्याख्याहरू विश्वको सबैभन्दा ठूलो डिजिटल सपना प्रतिवेदन संग्रहमा आधारित छन्',
    counter_label: 'वैज्ञानिक सपना प्रतिवेदनहरू विश्लेषण गरिएका',
    sources_title: 'हाम्रा अनुसन्धान डेटाबेसहरू',
    sddb_name: 'निद्रा र सपना डेटाबेस (SDDb)',
    sddb_count: '24,000+ सपना प्रतिवेदनहरू',
    sddb_desc: 'वैज्ञानिक रूपमा कोड गरिएका सपना प्रतिवेदनहरूको सबैभन्दा विस्तृत संग्रह',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / Dryad भण्डार',
    dreambank_count: '15,000+ सपना प्रतिवेदनहरू',
    dreambank_desc: 'हल-भ्यान डी क्यासल कोडिङ प्रणाली अनुसार टिप्पणी गरिएका',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'DREAM डेटाबेस (मोनाश विश्वविद्यालय)',
    dream_db_count: 'निरन्तर विस्तार',
    dream_db_desc: 'अस्ट्रेलियाबाट शैक्षिक सपना अनुसन्धान',
    method_title: 'हाम्रो विश्लेषण कसरी काम गर्छ',
    step1_title: 'चरण 1: एम्बेडिङ',
    step1_desc: 'तपाईंको सपनालाई गणितीय प्रतिनिधित्वमा (embedding) रूपान्तरण गरिन्छ',
    step2_title: 'चरण 2: ढाँचा खोज',
    step2_desc: '39,075+ वैज्ञानिक प्रतिवेदनहरूमा समान ढाँचाहरू खोज्छौं',
    step3_title: 'चरण 3: व्याख्या',
    step3_desc: 'AI ले उत्कृष्ट मिलानका आधारमा व्यक्तिगत व्याख्या सिर्जना गर्छ',
    hvcs_title: 'हल-भ्यान डी क्यासल प्रणाली',
    hvcs_desc: 'सपनाको सामग्रीको लागि विश्वव्यापी मान्यता प्राप्त कोडिङ प्रणाली',
    hvcs_cat_title: 'वर्गहरू:',
    hvcs_cats: ['भावनाहरू', 'पात्रहरू', 'अन्तरक्रियाहरू', 'वातावरणहरू'],
    hvcs_since: '1966 मा विकसित · सपना अनुसन्धानमा मानक',
    researcher_title: 'अनुसन्धानकर्ताहरूका लागि',
    api_title: 'अनुसन्धान API (छिट्टै आउँदैछ)',
    api_desc: 'शैक्षिक अनुसन्धानका लागि संकलित सपना डेटामा अज्ञात पहुँच',
    api_badge: 'बीटा Q2 2026',
    refs_title: 'वैज्ञानिक सन्दर्भहरू',
    cta_title: 'तपाईंको सपनाको व्याख्या गर्न तयार हुनुहुन्छ?',
    cta_btn: 'अहिले सपना प्रविष्ट गर्नुहोस्',
  },
  [Language.PRS]: {
    back: 'بازگشت',
    title: 'ساینس',
    hero_title: 'بنیاد علمی DreamCode',
    hero_subtitle: 'تعبیرهای خواب ما بر اساس بزرگ‌ترین مجموعه دیجیتلی گزارش‌های خواب در جهان است',
    counter_label: 'گزارش علمی خواب تحلیل شده',
    sources_title: 'دیتابیس‌های تحقیقاتی ما',
    sddb_name: 'دیتابیس خواب و رؤیا (SDDb)',
    sddb_count: '۲۴٬۰۰۰+ گزارش خواب',
    sddb_desc: 'جامع‌ترین مجموعه گزارش‌های خواب کدگذاری شده علمی',
    sddb_link: 'sleepanddreamdatabase.org',
    dreambank_name: 'DreamBank / مخزن Dryad',
    ...
    dreambank_desc: 'با سیستم کدگذاری هال-ون‌دکاسل حاشیه‌نویسی شده',
    dreambank_link: 'dreambank.net',
    dream_db_name: 'دیتابیس DREAM (پوهنتون موناش)',
    dream_db_count: 'گسترش مداوم',
    dream_db_desc: 'تحقیقات اکادمیک خواب از آسترالیا',
    method_title: 'طرز کار تحلیل ما',
    step1_title: 'مرحله ۱: جاسازی',
    step1_desc: 'خواب شما به یک نمایش ریاضی (embedding) تبدیل می‌شود',
    step2_title: 'مرحله ۲: جستجوی الگو',
    step2_desc: 'ما الگوهای مشابه را در ۳۹٬۰۷۵+ گزارش علمی جستجو می‌کنیم',
    step3_title: 'مرحله ۳: تعبیر',
    step3_desc: 'هوش مصنوعی بر اساس بهترین تطابق‌ها تعبیر شخصی‌سازی شده ایجاد می‌کند',
    hvcs_title: 'سیستم هال-ون‌دکاسل',
    hvcs_desc: 'سیستم کدگذاری محتوای خواب که در سطح جهانی پذیرفته شده است',
    hvcs_cat_title: 'دسته‌بندی‌ها:',
    hvcs_cats: ['احساسات', 'شخصیت‌ها', 'تعاملات', 'محیط‌ها'],
    hvcs_since: 'توسعه در ۱۹۶۶ · معیار در تحقیقات خواب',
    researcher_title: 'برای محققین',
    api_title: 'API تحقیقاتی (به‌زودی)',
    api_desc: 'دسترسی ناشناس به داده‌های تجمیعی خواب برای تحقیقات اکادمیک',
    api_badge: 'بتا Q2 2026',
    refs_title: 'مراجع علمی',
    cta_title: 'آماده تعبیر خوابتان استید؟',
    cta_btn: 'اکنون خواب را داخل کنید',
  },
};
...
const SciencePage: React.FC<SciencePageProps> = ({ language, onClose, onNavigateHome, onNavigateToStudies, themeMode }) => {
  ...
  const t = SCIENCE_TRANSLATIONS[language] || SCIENCE_TRANSLATIONS[language.startsWith("ar") ? Language.AR : Language.DE] || SCIENCE_TRANSLATIONS[Language.DE];

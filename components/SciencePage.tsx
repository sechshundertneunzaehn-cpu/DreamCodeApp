...
const SCIENCE_TRANSLATIONS: Record<Language, {
  ...
  [Language.DE]: {
    ...
    sddb_count: '44.500+ Traumberichte',
    ...
    dreambank_count: '20.000+ Traumberichte',
    ...
    step2_desc: 'Wir durchsuchen 64.500+ wissenschaftliche Berichte nach ähnlichen Mustern',
  ...
  [Language.EN]: {
    ...
    step2_desc: 'We search 64,500+ scientific reports for similar patterns',
  ...
  [Language.TR]: {
    ...
    step2_desc: '64.500+ bilimsel raporda benzer desenler aranır',
  ...
  [Language.ES]: {
    ...
    sddb_count: '44.500+ informes de sueños',
    ...
    dreambank_count: '20.000+ informes de sueños',
    ...
    step2_desc: 'Buscamos en 64.500+ informes científicos patrones similares',
  ...
  [Language.FR]: {
    ...
    sddb_count: '44 500+ rapports de rêves',
    ...
    dreambank_count: '20 000+ rapports de rêves',
    ...
    step2_desc: 'Nous recherchons des motifs similaires dans 64 500+ rapports scientifiques',
  ...
  [Language.AR]: {
    ...
    step2_desc: 'نبحث في أكثر من 64,500 تقرير علمي عن أنماط مماثلة',
  ...
  [Language.PT]: {
    ...
    sddb_count: '44.500+ relatórios de sonhos',
    ...
    dreambank_count: '20.000+ relatórios de sonhos',
    ...
    step2_desc: 'Pesquisamos em 64.500+ relatórios científicos por padrões similares',
  ...
  [Language.RU]: {
    ...
    step2_desc: 'Мы ищем похожие паттерны в 64 500+ научных отчётах',
...
const SciencePage: React.FC<SciencePageProps> = ({ language, onClose, onNavigateHome, themeMode }) => {
  ...
  const count = useCountUp(64500, 1800, counterStarted);

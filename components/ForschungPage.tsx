  ...
  >
    ...
    <p>
      {language === Language.DE
        ? 'DreamCode verbindet traditionelle Traumdeutung mit moderner KI-Technologie. Unsere Analysen basieren auf ueber 20 historischen und wissenschaftlichen Quellen.'
    ...
    <ul className="list-disc pl-6 space-y-2">
      <li>
        ...
        {language === Language.DE
          ? 'Ueber 30.000 Traumprotokolle aus wissenschaftlichen Studien'
          : 'Over 30,000 dream reports from scientific studies'}
      </li>
      <li>
        <strong>DreamBank</strong> —{' '}
        {language === Language.DE
          ? 'Umfangreiche Sammlung kodierter Traeume nach dem Hall-Van de Castle System'
      ...
      <li>
        ...
        {language === Language.DE
          ? 'Ibn Sirin, Al-Nabulsi, Kirchenvaeter, tibetische und Zen-buddhistische Traditionen'
    ...
    <p>
      {language === Language.DE
        ? 'Unsere KI nutzt Embedding-basierte Aehnlichkeitssuche ueber eine Vektordatenbank, um relevante Muster in historischen Traumprotokollen zu finden. Die Deutung kombiniert diese Muster mit quellenspezifischem Expertenwissen.'
    ...
    <p>
      {language === Language.DE
        ? 'Alle Deutungen werden klar als KI-generiert gekennzeichnet. Wir empfehlen ausdruecklich, bei psychischen Belastungen professionelle Hilfe aufzusuchen. DreamCode ersetzt keine Therapie.'

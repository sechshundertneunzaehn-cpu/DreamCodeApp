...
import { UserProfile, Dream, Language, FontSize, SubscriptionTier, ThemeMode, FacePhotoType } from '../types';
...
const GLOBAL_CATEGORIES = [
    { catId: 'nightmare', en: 'Nightmare', de: 'Albtraum', tr: 'Kabus', es: 'Pesadilla', fr: 'Cauchemar', ar: 'كابوس', pt: 'Pesadelo', ru: 'Кошмар', zh: '噩梦', hi: 'बुरा सपना', ja: '悪夢', ko: '악몽', id: 'Mimpi Buruk', fa: 'کابوس', it: 'Incubo', pl: 'Koszmar', bn: 'দুঃস্বপ্ন', ur: 'ڈراؤنا خواب', vi: 'Ác mộng', th: 'ฝันร้าย', sw: 'Ndoto Mbaya', hu: 'Rémálom', ta: 'கொடுங்கனவு', te: 'పీడకల', tl: 'Bangungot', ml: 'പേടിസ്വപ്നം', mr: 'भयानक स्वप्न', kn: 'ದುಃಸ್ವಪ್ನ', gu: 'ભયાનક સ્વપ્ન', he: 'סיוט', ne: 'दुःस्वप्न', prs: 'کابوس' },
    { catId: 'lucid', en: 'Lucid', de: 'Luzid', tr: 'Lüsid', es: 'Lúcido', fr: 'Lucide', ar: 'واضح', pt: 'Lúcido', ru: 'Осознанный', zh: '清醒梦', hi: 'स्पष्ट सपना', ja: '明晰夢', ko: '자각몽', id: 'Mimpi Sadar', fa: 'رویای آگاهانه', it: 'Sogno Lucido', pl: 'Świadomy Sen', bn: 'স্বচ্ছ স্বপ্ন', ur: 'واضح خواب', vi: 'Giấc mơ tỉnh', th: 'ฝันรู้ตัว', sw: 'Ndoto ya Fahamu', hu: 'Lucid Álom', ta: 'தெளிவான கனவு', te: 'స్పష్ట కల', tl: 'Malinaw na Panaginip', ml: 'സ്പഷ്ടസ്വപ്നം', mr: 'स्पष्ट स्वप्न', kn: 'ಸ್ಪಷ್ಟ ಕನಸು', gu: 'સ્પષ્ટ સ્વપ્ન', he: 'חלום צלול', ne: 'स्पष्ट सपना', prs: 'خواب روشن' },
    { catId: 'recurring', en: 'Recurring', de: 'Wiederkehrend', tr: 'Tekrarlayan', es: 'Recurrente', fr: 'Récurrent', ar: 'متكرر', pt: 'Recorrente', ru: 'Повторяющийся', zh: '反复出现', hi: 'बार-बार आने वाला', ja: '繰り返す', ko: '반복되는', id: 'Berulang', fa: 'تکراری', it: 'Ricorrente', pl: 'Powtarzający się', bn: 'পুনরাবৃত্তি', ur: 'بار بار آنے والا', vi: 'Tái diễn', th: 'ฝันซ้ำ', sw: 'Ndoto Inayorudiwa', hu: 'Visszatérő', ta: 'மீண்டும் வரும்', te: 'పునరావృత', tl: 'Paulit-ulit', ml: 'ആവർത്തിക്കുന്ന', mr: 'पुनरावृत्ती', kn: 'ಪುನರಾವರ್ತಿತ', gu: 'પુનરાવર્તિત', he: 'חוזר', ne: 'दोहोरिने', prs: 'تکراری' },
    { catId: 'prophetic', en: 'Prophetic', de: 'Prophetisch', tr: 'Kehanet', es: 'Profético', fr: 'Prophétique', ar: 'نبوي', pt: 'Profético', ru: 'Вещий', zh: '预言梦', hi: 'भविष्यसूचक', ja: '予言的', ko: '예언적', id: 'Profetik', fa: 'نبوی', it: 'Profetico', pl: 'Proroczy', bn: 'ভবিষ্যদ্বাণীমূলক', ur: 'نبوی خواب', vi: 'Tiên tri', th: 'ฝันพยากรณ์', sw: 'Ndoto ya Unabii', hu: 'Prófétikus', ta: 'தீர்க்கதரிசன', te: 'ప్రవచనాత్మక', tl: 'Propetiko', ml: 'പ്രവചനാത്മക', mr: 'भविष्यवाणी', kn: 'ಭವಿಷ್ಯವಾಣಿ', gu: 'ભવિષ્યવાણી', he: 'נבואי', ne: 'भविष्यसूचक', prs: 'پیشگویانه' },
    { catId: 'healing', en: 'Healing', de: 'Heilung', tr: 'Şifa', es: 'Sanador', fr: 'Guérison', ar: 'شفاء', pt: 'Cura', ru: 'Исцеляющий', zh: '治愈', hi: 'उपचार', ja: '癒し', ko: '치유', id: 'Penyembuhan', fa: 'شفابخش', it: 'Guarigione', pl: 'Uzdrowienie', bn: 'নিরাময়', ur: 'شفاء', vi: 'Chữa lành', th: 'การเยียวยา', sw: 'Uponyaji', hu: 'Gyógyító', ta: 'குணமாக்கும்', te: 'స్వస్థత', tl: 'Nakapagpapagaling', ml: 'രോഗശാന്തി', mr: 'उपचार', kn: 'ಗುಣಪಡಿಸುವ', gu: 'ઉપચાર', he: 'ריפוי', ne: 'उपचार', prs: 'شفابخش' },
    { catId: 'funny', en: 'Funny', de: 'Lustig', tr: 'Komik', es: 'Gracioso', fr: 'Drôle', ar: 'مضحك', pt: 'Engraçado', ru: 'Смешной', zh: '有趣', hi: 'मज़ेदार', ja: '面白い', ko: '재미있는', id: 'Lucu', fa: 'خنده‌دار', it: 'Divertente', pl: 'Śmieszny', bn: 'মজার', ur: 'مضحکہ خیز', vi: 'Vui nhộn', th: 'ตลก', sw: 'Ya Kuchekesha', hu: 'Vicces', ta: 'வேடிக்கை', te: 'హాస్యం', tl: 'Nakakatawa', ml: 'രസകരം', mr: 'मजेदार', kn: 'ತಮಾಷೆ', gu: 'રમૂજી', he: 'מצחיק', ne: 'हास्यास्पद', prs: 'خنده‌دار' },
    { catId: 'scary', en: 'Scary', de: 'Gruselig', tr: 'Korkunç', es: 'Aterrador', fr: 'Effrayant', ar: 'مخيف', pt: 'Assustador', ru: 'Страшный', zh: '恐怖', hi: 'डरावना', ja: '怖い', ko: '무서운', id: 'Menakutkan', fa: 'ترسناک', it: 'Spaventoso', pl: 'Straszny', bn: 'ভয়ঙ্কর', ur: 'ڈراؤنا', vi: 'Đáng sợ', th: 'น่ากลัว', sw: 'Ya Kutisha', hu: 'Ijesztő', ta: 'பயமுறுத்தும்', te: 'భయానక', tl: 'Nakakatakot', ml: 'ഭയാനകം', mr: 'भयावह', kn: 'ಭಯಾನಕ', gu: 'ડરામણું', he: 'מפחיד', ne: 'डरलाग्दो', prs: 'ترسناک' },
    { catId: 'weird', en: 'Weird', de: 'Seltsam', tr: 'Garip', es: 'Extraño', fr: 'Étrange', ar: 'غريب', pt: 'Estranho', ru: 'Странный', zh: '奇怪', hi: 'अजीब', ja: '奇妙', ko: '이상한', id: 'Aneh', fa: 'عجیب', it: 'Strano', pl: 'Dziwny', bn: 'অদ্ভুত', ur: 'عجیب', vi: 'Kỳ lạ', th: 'แปลก', sw: 'Ya Ajabu', hu: 'Furcsa', ta: 'வினோதம்', te: 'విచిత్రం', tl: 'Kakaiba', ml: 'വിചിത്രം', mr: 'विचित्र', kn: 'ವಿಚಿತ್ರ', gu: 'વિચિત્ર', he: 'מוזר', ne: 'अनौठो', prs: 'عجیب' },
    { catId: 'sexual', en: 'Erotic', de: 'Erotisch', tr: 'Erotik', es: 'Erótico', fr: 'Érotique', ar: 'إثارة', pt: 'Erótico', ru: 'Эротический', zh: '情色', hi: 'कामुक', ja: 'エロティック', ko: '에로틱', id: 'Erotis', fa: 'عاشقانه', it: 'Erotico', pl: 'Erotyczny', bn: 'কামোত্তেজক', ur: 'جنسی', vi: 'Gợi cảm', th: 'เร้าใจ', sw: 'Ya Ngono', hu: 'Erotikus', ta: 'காமம்', te: 'శృంగారం', tl: 'Erotiko', ml: 'ശൃംഗാരം', mr: 'कामुक', kn: 'ಕಾಮಪ್ರಚೋದಕ', gu: 'શૃંગારિક', he: 'ארוטי', ne: 'कामुक', prs: 'عاشقانه' },
    { catId: 'spiritual', en: 'Spiritual', de: 'Spirituell', tr: 'Manevi', es: 'Espiritual', fr: 'Spirituel', ar: 'روحاني', pt: 'Espiritual', ru: 'Духовный', zh: '灵性', hi: 'आध्यात्मिक', ja: 'スピリチュアル', ko: '영적', id: 'Spiritual', fa: 'معنوی', it: 'Spirituale', pl: 'Duchowy', bn: 'আধ্যাত্মিক', ur: 'روحانی', vi: 'Tâm linh', th: 'จิตวิญญาณ', sw: 'Kiroho', hu: 'Spirituális', ta: 'ஆன்மிக', te: 'ఆధ్యాత్మిక', tl: 'Espirituwal', ml: 'ആത്മീയം', mr: 'आध्यात्मिक', kn: 'ಆಧ್ಯಾತ್ಮಿಕ', gu: 'આધ્યાત્મિક', he: 'רוחני', ne: 'आध्यात्मिक', prs: 'معنوی' },
    { catId: 'shadow', en: 'Shadow Work', de: 'Schattenarbeit', tr: 'Gölge Çalışması', es: 'Trabajo de Sombra', fr: 'Travail d\'Ombre', ar: 'عمل الظل', pt: 'Trabalho de Sombra', ru: 'Теневая Работа', zh: '阴影工作', hi: 'छाया कार्य', ja: 'シャドーワーク', ko: '그림자 작업', id: 'Kerja Bayangan', fa: 'کار سایه', it: 'Lavoro sull\'Ombra', pl: 'Praca z Cieniem', bn: 'ছায়া কাজ', ur: 'سایہ کاری', vi: 'Công việc bóng tối', th: 'งานเงา', sw: 'Kazi ya Kivuli', hu: 'Árnyékmunka', ta: 'நிழல் வேலை', te: 'నీడ పని', tl: 'Gawaing Anino', ml: 'നിഴൽ പ്രവർത്തനം', mr: 'छाया कार्य', kn: 'ನೆರಳು ಕೆಲಸ', gu: 'છાયા કાર્ય', he: 'עבודת צל', ne: 'छाया कार्य', prs: 'کار سایه' },
    { catId: 'animals', en: 'Animals', de: 'Tiere', tr: 'Hayvanlar', es: 'Animales', fr: 'Animaux', ar: 'حيوانات', pt: 'Animais', ru: 'Животные', zh: '动物', hi: 'जानवर', ja: '動物', ko: '동물', id: 'Hewan', fa: 'حیوانات', it: 'Animali', pl: 'Zwierzęta', bn: 'প্রাণী', ur: 'جانور', vi: 'Động vật', th: 'สัตว์', sw: 'Wanyama', hu: 'Állatok', ta: 'விலங்குகள்', te: 'జంతువులు', tl: 'Mga Hayop', ml: 'മൃഗങ്ങൾ', mr: 'प्राणी', kn: 'ಪ್ರಾಣಿಗಳು', gu: 'પ્રાણીઓ', he: 'חיות', ne: 'जनावरहरू', prs: 'حیوانات' },
    { catId: 'flying', en: 'Flying', de: 'Fliegen', tr: 'Uçmak', es: 'Volar', fr: 'Voler', ar: 'طيران', pt: 'Voar', ru: 'Полёт', zh: '飞翔', hi: 'उड़ना', ja: '飛ぶ', ko: '나는', id: 'Terbang', fa: 'پرواز', it: 'Volare', pl: 'Latanie', bn: 'উড়া', ur: 'اڑنا', vi: 'Bay', th: 'บิน', sw: 'Kuruka', hu: 'Repülés', ta: 'பறத்தல்', te: 'ఎగరడం', tl: 'Paglipad', ml: 'പറക്കൽ', mr: 'उडणे', kn: 'ಹಾರಾಟ', gu: 'ઉડાન', he: 'טיסה', ne: 'उड्ने', prs: 'پرواز' },
    { catId: 'falling', en: 'Falling', de: 'Fallen', tr: 'Düşmek', es: 'Caer', fr: 'Tomber', ar: 'سقوط', pt: 'Cair', ru: 'Падение', zh: '坠落', hi: 'गिरना', ja: '落ちる', ko: '떨어지는', id: 'Jatuh', fa: 'افتادن', it: 'Cadere', pl: 'Spadanie', bn: 'পড়া', ur: 'گرنا', vi: 'Rơi', th: 'ตก', sw: 'Kuanguka', hu: 'Esés', ta: 'விழுதல்', te: 'పడటం', tl: 'Pagbagsak', ml: 'വീഴ്ച', mr: 'पडणे', kn: 'ಬೀಳುವಿಕೆ', gu: 'પડવું', he: 'נפילה', ne: 'खस्ने', prs: 'افتادن' }
];
...
const profileTranslations = {
    ...
    [Language.TA]: { posts: "கனவுகள்", followers: "நண்பர்கள்", following: "பின்தொடர்பவை", edit: "சுயவிவரம் திருத்து", cancel: "ரத்துசெய்", share: "பகிர்", social_title: "சமூக இணைப்புகள்", basics_title: "அடையாளம்", name_label: "காட்சிப் பெயர்", bio_label: "தலைப்பு / பாத்திரம்", remarks_label: "சுயவிவரம் / குறிப்புகள்", remarks_placeholder: "உங்கள் பயணத்தைப் பற்றி எழுதுங்கள்...", website_label: "இணையதளம்", save: "சுயவிவரம் சேமி", no_posts: "கனவுகள் இல்லை", no_posts_desc: "இங்கே காண ஒரு கனவை விளக்குங்கள்.", no_videos: "இன்னும் வீடியோக்கள் இல்லை.", no_videos_desc: "இங்கே காண வீடியோ உருவாக்குங்கள்.", no_matches: "பொருத்தங்கள் இல்லை", no_matches_desc: "ஆன்ம தோழரைக் கண்டறிய இணையுங்கள்.", likes: "விருப்பங்கள்", bio_default: "கனவு ஆராய்ச்சியாளர்", tab_grid: "கனவுகள்", tab_video: "வீடியோ", tab_matches: "பொருத்தங்கள்", tab_audio: "ஒலி", new_story: "வகை", manage_cats: "நிர்வகி", upload_photo: "புகைப்படம்", match_score: "பொருத்தம்", website: "இணையதளம்", tier_free: "இலவசம்", tier_silver: "ப்ரோ", tier_gold: "பிரீமியம்", tier_vip: "VIP", your_dream: "உங்கள் கனவு", btn_video: "கனவு வீடியோ உருவாக்கு", btn_narration: "கனவு விவரிப்பு வீடியோ", btn_user_voice: "உங்கள் குரலில் வீடியோ (+5 நாணயங்கள்)", btn_play_video: "சேமித்த வீடியோவை இயக்கு", age_restricted: "இந்த வகை 18 வயது மற்றும் அதற்கு மேற்பட்ட பயனர்களுக்கு மட்டுமே கிடைக்கும்." },
    [Language.TE]: { posts: "కలలు", followers: "స్నేహితులు", following: "అనుసరిస్తున్నవి", edit: "ప్రొఫైల్ సవరించు", cancel: "రద్దు", share: "షేర్", social_title: "సోషల్ లింక్‌లు", basics_title: "గుర్తింపు", name_label: "ప్రదర్శన పేరు", bio_label: "శీర్షిక / పాత్ర", remarks_label: "బయో / వ్యాఖ్యలు", remarks_placeholder: "మీ ప్రయాణం గురించి ఏదైనా రాయండి...", website_label: "వెబ్‌సైట్", save: "ప్రొఫైల్ సేవ్ చేయి", no_posts: "కలలు లేవు", no_posts_desc: "ఇక్కడ చూడటానికి ఒక కలను వివరించండి.", no_videos: "ఇంకా వీడియోలు లేవు.", no_videos_desc: "ఇక్కడ చూడటానికి వీడియో రూపొందించండి.", no_matches: "సరిపోలికలు లేవు", no_matches_desc: "ఆత్మ మిత్రుడిని కనుగొనడానికి కనెక్ట్ అవ్వండి.", likes: "ఇష్టాలు", bio_default: "కల అన్వేషకుడు", tab_grid: "కలలు", tab_video: "వీడియో", tab_matches: "సరిపోలికలు", tab_audio: "ఆడియో", new_story: "వర్గం", manage_cats: "నిర్వహించు", upload_photo: "ఫోటో", match_score: "సరిపోలిక", website: "వెబ్‌సైట్", tier_free: "ఉచితం", tier_silver: "ప్రో", tier_gold: "ప్రీమియం", tier_vip: "VIP", your_dream: "మీ కల", btn_video: "కల వీడియో రూపొందించు", btn_narration: "కల వివరణ వీడియో", btn_user_voice: "మీ గొంతుతో వీడియో (+5 నాణేలు)", btn_play_video: "సేవ్ చేసిన వీడియో ప్లే చేయి", age_restricted: "ఈ వర్గం 18 సంవత్సరాలు మరియు అంతకంటే ఎక్కువ వయస్సు ఉన్న వినియోగదారులకు మాత్రమే అందుబాటులో ఉంటుంది." },
    [Language.TL]: { posts: "Mga Panaginip", followers: "Mga Kaibigan", following: "Sinusundan", edit: "I-edit ang Profile", cancel: "Kanselahin", share: "Ibahagi", social_title: "Mga Social Link", basics_title: "Pagkakakilanlan", name_label: "Display Name", bio_label: "Titulo / Tungkulin", remarks_label: "Bio / Mga Puna", remarks_placeholder: "Sumulat ng tungkol sa iyong paglalakbay...", website_label: "Website", save: "I-save ang Profile", no_posts: "Walang Panaginip", no_posts_desc: "Bigyang-kahulugan ang isang panaginip para makita dito.", no_videos: "Wala pang video.", no_videos_desc: "Gumawa ng video para makita dito.", no_matches: "Walang Tugma", no_matches_desc: "Kumonekta para makahanap ng kaluluwa.", likes: "gusto", bio_default: "Mananaliksik ng Panaginip", tab_grid: "Panaginip", tab_video: "Video", tab_matches: "Mga Tugma", tab_audio: "Audio", new_story: "Kategorya", manage_cats: "Pamahalaan", upload_photo: "Larawan", match_score: "Tugma", website: "Website", tier_free: "Libre", tier_silver: "Pro", tier_gold: "Premium", tier_vip: "VIP", your_dream: "Ang Panaginip Mo", btn_video: "Gumawa ng Dream Video", btn_narration: "Video ng Kwento ng Panaginip", btn_user_voice: "Video gamit ang Boses Mo (+5 Barya)", btn_play_video: "I-play ang Naka-save na Video", age_restricted: "Ang kategoryang ito ay para lamang sa mga user na 18 taong gulang pataas." },
    [Language.ML]: { posts: "സ്വപ്നങ്ങൾ", followers: "സുഹൃത്തുക്കൾ", following: "പിന്തുടരുന്നവ", edit: "പ്രൊഫൈൽ തിരുത്തുക", cancel: "റദ്ദാക്കുക", share: "പങ്കിടുക", social_title: "സോഷ്യൽ ലിങ്കുകൾ", basics_title: "ഐഡന്റിറ്റി", name_label: "ഡിസ്‌പ്ലേ നാമം", bio_label: "ശീർഷകം / പങ്ക്", remarks_label: "ബയോ / കുറിപ്പുകൾ", remarks_placeholder: "നിങ്ങളുടെ യാത്രയെക്കുറിച്ച് എഴുതുക...", website_label: "വെബ്‌സൈറ്റ്", save: "പ്രൊഫൈൽ സേവ് ചെയ്യുക", no_posts: "സ്വപ്നങ്ങൾ ഇല്ല", no_posts_desc: "ഇവിടെ കാണാൻ ഒരു സ്വപ്നം വ്യാഖ്യാനിക്കുക.", no_videos: "ഇതുവരെ വീഡിയോകൾ ഇല്ല.", no_videos_desc: "ഇവിടെ കാണാൻ ഒരു വീഡിയോ സൃഷ്ടിക്കുക.", no_matches: "പൊരുത്തങ്ങൾ ഇല്ല", no_matches_desc: "ആത്മ മിത്രത്തെ കണ്ടെത്താൻ ബന്ധിപ്പിക്കുക.", likes: "ഇഷ്ടങ്ങൾ", bio_default: "സ്വപ്ന പര്യവേക്ഷകൻ", tab_grid: "സ്വപ്നങ്ങൾ", tab_video: "വീഡിയോ", tab_matches: "പൊരുത്തങ്ങൾ", tab_audio: "ഓഡിയോ", new_story: "വിഭാഗം", manage_cats: "നിയന്ത്രിക്കുക", upload_photo: "ഫോട്ടോ", match_score: "പൊരുത്തം", website: "വെബ്‌സൈറ്റ്", tier_free: "സൗജന്യം", tier_silver: "പ്രോ", tier_gold: "പ്രീമിയം", tier_vip: "VIP", your_dream: "നിങ്ങളുടെ സ്വപ്നം", btn_video: "സ്വപ്ന വീഡിയോ സൃഷ്ടിക്കുക", btn_narration: "സ്വപ്ന വിവരണ വീഡിയോ", btn_user_voice: "നിങ്ങളുടെ ശബ്ദത്തിൽ വീഡിയോ (+5 നാണയങ്ങൾ)", btn_play_video: "സേവ് ചെയ്ത വീഡിയോ പ്ലേ ചെയ്യുക", age_restricted: "ഈ വിഭാഗം 18 വയസ്സും അതിനു മുകളിലുമുള്ള ഉപയോക്താക്കൾക്ക് മാത്രമേ ലഭ്യമാകൂ." },
    [Language.MR]: { posts: "स्वप्ने", followers: "मित्र", following: "अनुसरण", edit: "प्रोफाइल संपादित करा", cancel: "रद्द करा", share: "शेअर करा", social_title: "सोशल लिंक्स", basics_title: "ओळख", name_label: "प्रदर्शन नाव", bio_label: "शीर्षक / भूमिका", remarks_label: "बायो / टिपणी", remarks_placeholder: "तुमच्या प्रवासाबद्दल काहीतरी लिहा...", website_label: "वेबसाइट", save: "प्रोफाइल जतन करा", no_posts: "स्वप्ने नाहीत", no_posts_desc: "येथे पाहण्यासाठी एक स्वप्न स्पष्ट करा.", no_videos: "अजून व्हिडिओ नाहीत.", no_videos_desc: "येथे पाहण्यासाठी व्हिडिओ तयार करा.", no_matches: "जुळणी नाही", no_matches_desc: "आत्म्याचा जोडीदार शोधण्यासाठी जोडा.", likes: "आवडी", bio_default: "स्वप्न संशोधक", tab_grid: "स्वप्ने", tab_video: "व्हिडिओ", tab_matches: "जुळणी", tab_audio: "ऑडिओ", new_story: "वर्ग", manage_cats: "व्यवस्थापन", upload_photo: "फोटो", match_score: "जुळणी", website: "वेबसाइट", tier_free: "मोफत", tier_silver: "प्रो", tier_gold: "प्रीमियम", tier_vip: "VIP", your_dream: "तुमचे स्वप्न", btn_video: "स्वप्न व्हिडिओ तयार करा", btn_narration: "स्वप्न कथन व्हिडिओ", btn_user_voice: "तुमच्या आवाजात व्हिडिओ (+5 नाणी)", btn_play_video: "जतन केलेला व्हिडिओ प्ले करा", age_restricted: "हा वर्ग फक्त 18 वर्षे व त्याहून अधिक वयाच्या वापरकर्त्यांसाठी उपलब्ध आहे." },
    [Language.KN]: { posts: "ಕನಸುಗಳು", followers: "ಸ್ನೇಹಿತರು", following: "ಅನುಸರಿಸುತ್ತಿರುವವು", edit: "ಪ್ರೊಫೈಲ್ ಸಂಪಾದಿಸಿ", cancel: "ರದ್ದುಮಾಡಿ", share: "ಹಂಚಿಕೊಳ್ಳಿ", social_title: "ಸೋಶಿಯಲ್ ಲಿಂಕ್‌ಗಳು", basics_title: "ಗುರುತು", name_label: "ಪ್ರದರ್ಶನ ಹೆಸರು", bio_label: "ಶೀರ್ಷಿಕೆ / ಪಾತ್ರ", remarks_label: "ಬಯೋ / ಟಿಪ್ಪಣಿಗಳು", remarks_placeholder: "ನಿಮ್ಮ ಪ್ರಯಾಣದ ಬಗ್ಗೆ ಏನಾದರೂ ಬರೆಯಿರಿ...", website_label: "ವೆಬ್‌ಸೈಟ್", save: "ಪ್ರೊಫೈಲ್ ಉಳಿಸಿ", no_posts: "ಕನಸುಗಳಿಲ್ಲ", no_posts_desc: "ಇಲ್ಲಿ ನೋಡಲು ಕನಸನ್ನು ವ್ಯಾಖ್ಯಾನಿಸಿ.", no_videos: "ಇನ್ನೂ ವೀಡಿಯೊಗಳಿಲ್ಲ.", no_videos_desc: "ಇಲ್ಲಿ ನೋಡಲು ವೀಡಿಯೊ ರಚಿಸಿ.", no_matches: "ಹೊಂದಾಣಿಕೆಗಳಿಲ್ಲ", no_matches_desc: "ಆತ್ಮ ಸಂಗಾತಿಯನ್ನು ಹುಡುಕಲು ಸಂಪರ್ಕಿಸಿ.", likes: "ಇಷ್ಟಗಳು", bio_default: "ಕನಸು ಅನ್ವೇಷಕ", tab_grid: "ಕನಸುಗಳು", tab_video: "ವೀಡಿಯೊ", tab_matches: "ಹೊಂದಾಣಿಕೆಗಳು", tab_audio: "ಆಡಿಯೊ", new_story: "ವರ್ಗ", manage_cats: "ನಿರ್ವಹಿಸಿ", upload_photo: "ಫೋಟೋ", match_score: "ಹೊಂದಾಣಿಕೆ", website: "ವೆಬ್‌ಸೈಟ್", tier_free: "ಉಚಿತ", tier_silver: "ಪ್ರೊ", tier_gold: "ಪ್ರೀಮಿಯಂ", tier_vip: "VIP", your_dream: "ನಿಮ್ಮ ಕನಸು", btn_video: "ಕನಸು ವೀಡಿಯೊ ರಚಿಸಿ", btn_narration: "ಕನಸು ನಿರೂಪಣೆ ವೀಡಿಯೊ", btn_user_voice: "ನಿಮ್ಮ ಧ್ವನಿಯಲ್ಲಿ ವೀಡಿಯೊ (+5 ನಾಣ್ಯಗಳು)", btn_play_video: "ಉಳಿಸಿದ ವೀಡಿಯೊ ಪ್ಲೇ ಮಾಡಿ", age_restricted: "ಈ ವರ್ಗವು 18 ವರ್ಷ ಮತ್ತು ಅದಕ್ಕಿಂತ ಹೆಚ್ಚಿನ ವಯಸ್ಸಿನ ಬಳಕೆದಾರರಿಗೆ ಮಾತ್ರ ಲಭ್ಯವಿದೆ." },
    [Language.GU]: { posts: "સ્વપ્નો", followers: "મિત્રો", following: "અનુસરણ", edit: "પ્રોફાઇલ સંપાદિત કરો", cancel: "રદ કરો", share: "શેર કરો", social_title: "સોશિયલ લિંક્સ", basics_title: "ઓળખ", name_label: "પ્રદર્શન નામ", bio_label: "શીર્ષક / ભૂમિકા", remarks_label: "બાયો / ટિપ્પણીઓ", remarks_placeholder: "તમારી યાત્રા વિશે કંઈક લખો...", website_label: "વેબસાઇટ", save: "પ્રોફાઇલ સાચવો", no_posts: "કોઈ સ્વપ્નો નથી", no_posts_desc: "અહીં જોવા માટે સ્વપ્નનું અર્થઘટન કરો.", no_videos: "હજુ સુધી કોઈ વીડિયો નથી.", no_videos_desc: "અહીં જોવા માટે વીડિયો બનાવો.", no_matches: "કોઈ મેળ નથી", no_matches_desc: "આત્માનો સાથી શોધવા જોડાઓ.", likes: "પસંદ", bio_default: "સ્વપ્ન સંશોધક", tab_grid: "સ્વપ્નો", tab_video: "વીડિયો", tab_matches: "મેળ", tab_audio: "ઓડિયો", new_story: "શ્રેણી", manage_cats: "વ્યવસ્થાપન", upload_photo: "ફોટો", match_score: "મેળ", website: "વેબસાઇટ", tier_free: "મફત", tier_silver: "પ્રો", tier_gold: "પ્રીમિયમ", tier_vip: "VIP", your_dream: "તમારું સ્વપ્ન", btn_video: "સ્વપ્ન વીડિયો બનાવો", btn_narration: "સ્વપ્ન વર્ણન વીડિયો", btn_user_voice: "તમારા અવાજમાં વીડિયો (+5 સિક્કા)", btn_play_video: "સાચવેલ વીડિયો ચલાવો", age_restricted: "આ શ્રેણી ફક્ત 18 વર્ષ અને તેથી વધુ ઉંમરના વપરાશકર્તાઓ માટે ઉપલબ્ધ છે." },
    [Language.HE]: { posts: "חלומות", followers: "חברים", following: "עוקבים", edit: "עריכת פרופיל", cancel: "ביטול", share: "שיתוף", social_title: "קישורים חברתיים", basics_title: "זהות", name_label: "שם תצוגה", bio_label: "כותרת / תפקיד", remarks_label: "ביוגרפיה / הערות", remarks_placeholder: "כתוב משהו על המסע שלך...", website_label: "אתר אינטרנט", save: "שמור פרופיל", no_posts: "אין חלומות עדיין", no_posts_desc: "פרש חלום כדי לראות אותו כאן.", no_videos: "אין סרטונים עדיין.", no_videos_desc: "צור סרטון כדי לראות אותו כאן.", no_matches: "אין התאמות", no_matches_desc: "התחבר כדי למצוא נשמה תאומה.", likes: "לייקים", bio_default: "חוקר חלומות", tab_grid: "חלומות", tab_video: "סרטונים", tab_matches: "התאמות", tab_audio: "שמע", new_story: "קטגוריה", manage_cats: "ניהול", upload_photo: "תמונה", match_score: "התאמה", website: "אתר", tier_free: "חינם", tier_silver: "פרו", tier_gold: "פרימיום", tier_vip: "VIP", your_dream: "החלום שלך", btn_video: "צור סרטון חלום", btn_narration: "סרטון סיפור חלום", btn_user_voice: "סרטון בקול שלך (+5 מטבעות)", btn_play_video: "נגן סרטון שמור", age_restricted: "קטגוריה זו זמינה רק למשתמשים בני 18 ומעלה." },
    [Language.NE]: { posts: "सपनाहरू", followers: "साथीहरू", following: "फलो गरिएको", edit: "प्रोफाइल सम्पादन", cancel: "रद्द गर्नुहोस्", share: "साझा गर्नुहोस्", social_title: "सामाजिक लिंकहरू", basics_title: "पहिचान", name_label: "प्रदर्शन नाम", bio_label: "शीर्षक / भूमिका", remarks_label: "बायो / टिप्पणी", remarks_placeholder: "तपाईंको यात्राको बारेमा केही लेख्नुहोस्...", website_label: "वेबसाइट", save: "प्रोफाइल सेभ गर्नुहोस्", no_posts: "सपनाहरू छैनन्", no_posts_desc: "यहाँ हेर्नको लागि सपनाको व्याख्या गर्नुहोस्.", no_videos: "अहिलेसम्म भिडियो छैन.", no_videos_desc: "यहाँ हेर्नको लागि भिडियो बनाउनुहोस्.", no_matches: "कुनै मिलान छैन", no_matches_desc: "आत्माको साथी फेला पार्न जोडिनुहोस्.", likes: "मनपर्ने", bio_default: "सपना अन्वेषक", tab_grid: "सपनाहरू", tab_video: "भिडियो", tab_matches: "मिलान", tab_audio: "अडियो", new_story: "श्रेणी", manage_cats: "व्यवस्थापन", upload_photo: "फोटो", match_score: "मिलान", website: "वेबसाइट", tier_free: "निःशुल्क", tier_silver: "प्रो", tier_gold: "प्रिमियम", tier_vip: "VIP", your_dream: "तपाईंको सपना", btn_video: "सपना भिडियो बनाउनुहोस्", btn_narration: "सपना कथन भिडियो", btn_user_voice: "तपाईंको आवाजमा भिडियो (+5 सिक्का)", btn_play_video: "सेभ गरिएको भिडियो प्ले गर्नुहोस्", age_restricted: "यो श्रेणी 18 वर्ष र माथिका प्रयोगकर्ताहरूका लागि मात्र उपलब्ध छ." },
    [Language.PRS]: { posts: "خواب‌ها", followers: "دوستان", following: "دنبال‌شده", edit: "ویرایش نمایه", cancel: "لغو", share: "شریک‌سازی", social_title: "لینک‌های اجتماعی", basics_title: "هویت", name_label: "نام نمایشی", bio_label: "عنوان / نقش", remarks_label: "معرفی / یادداشت", remarks_placeholder: "درباره سفر تان چیزی بنویسید...", website_label: "وبسایت", save: "ذخیره نمایه", no_posts: "هنوز خوابی نیست", no_posts_desc: "یک خواب را تعبیر کنید تا اینجا ببینید.", no_videos: "هنوز ویدیویی نیست.", no_videos_desc: "یک ویدیو بسازید تا اینجا ببینید.", no_matches: "تطابقی نیست", no_matches_desc: "برای یافتن همزاد وصل شوید.", likes: "پسند", bio_default: "کاوشگر خواب", tab_grid: "خواب‌ها", tab_video: "ویدیو", tab_matches: "تطابق", tab_audio: "صوت", new_story: "دسته‌بندی", manage_cats: "مدیریت", upload_photo: "عکس", match_score: "تطابق", website: "وبسایت", tier_free: "رایگان", tier_silver: "حرفه‌ای", tier_gold: "ویژه", tier_vip: "VIP", your_dream: "خواب شما", btn_video: "ساخت ویدیوی خواب", btn_narration: "ویدیوی روایت خواب", btn_user_voice: "ویدیو با صدای شما (+۵ سکه)", btn_play_video: "پخش ویدیوی ذخیره‌شده", age_restricted: "این دسته‌بندی تنها برای کاربران ۱۸ سال و بالاتر در دسترس است." }
};
...
const Profile: React.FC<ProfileProps> = ({ userProfile, dreams: propDreams, onUpdateProfile, onOpenVideoStudio, onPlayVideo, onUpdateDream, fontSize, language, themeMode }) => {
    ...
    const getCatLabel = (id: string) => {
        ...
        switch (language) {
            ...
            case Language.AR: case Language.AR_GULF: case Language.AR_EG: case Language.AR_LEV: case Language.AR_MAG: case Language.AR_IQ: return cat.ar;
            ...
            case Language.TA: return cat.ta;
            case Language.TE: return cat.te;
            case Language.TL: return cat.tl;
            case Language.ML: return cat.ml;
            case Language.MR: return cat.mr;
            case Language.KN: return cat.kn;
            case Language.GU: return cat.gu;
            case Language.HE: return cat.he;
            case Language.NE: return cat.ne;
            case Language.PRS: return cat.prs;
        ...
        <div dir={isRtl ? 'rtl' : 'ltr'} className={`max-w-2xl mx-auto pb-24 animate-in fade-in duration-500 bg-transparent min-h-screen ${textMain}`}>
            ...
            <div className={`${bgCard} backdrop-blur-xl rounded-[2rem] border overflow-hidden mb-6`}>
                ...
                <div className="px-6 pb-6 -mt-10 relative z-10">
                    ...
                    <button
                        onClick={() => {
                            if (userProfile?.faceData?.hasPhotos) {
                                setShowFaceManage(true);
                            } else {
                                setShowFaceUpload(true);
                            }
                        }}
                        className={`w-full mb-4 px-4 py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98] ${
                            userProfile?.faceData?.hasPhotos
                                ? isLight ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-gradient-to-r from-green-600/20 to-emerald-600/20 text-green-400 border border-green-500/30'
                                : isLight ? 'bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 border border-blue-200' : 'bg-gradient-to-r from-cyan-600/20 to-blue-600/20 text-cyan-300 border border-cyan-500/30'
                        }`}
                    >
                        <span className="material-icons text-lg">face</span>
                        {userProfile?.faceData?.hasPhotos ? 'Gesicht verwalten' : 'Gesicht hochladen'}
                    </button>
                     ...
                     {videoDreams.length > 0 ? videoDreams.map(dream => (
                         <div key={dream.id} className="rounded-2xl overflow-hidden border border-white/10 relative cursor-pointer hover:border-fuchsia-500/50 transition-all" onClick={() => onPlayVideo?.(dream.videoUrl!)}>
                             ...
                             <div className="p-3 bg-slate-900/80">
                                 <TranslatedText text={dream.title} sourceId={dream.id} table="user_dreams" field="title" as="h4" className="text-sm font-bold text-white" />
                ...
                <div className="fixed inset-0 z-[70] bg-black/95 backdrop-blur-xl flex items-center justify-center p-4 animate-in zoom-in-95 duration-300" onClick={() => setSelectedDream(null)}>
                     <div className="bg-dream-card border border-white/10 w-full max-w-lg h-[85vh] rounded-3xl overflow-y-auto relative flex flex-col shadow-2xl" onClick={e => e.stopPropagation()}>
                         ...
                         <div className="p-8 pb-32">
                             ...
                             <TranslatedText text={selectedDream.title} sourceId={selectedDream.id} table="user_dreams" field="title" as="h2" className="text-2xl font-mystic text-white mb-4" />
            ...
            {showFaceManage && (
                <Suspense fallback={null}>
                    <FaceManage
                        ...
                        userProfile={userProfile}
                        onUpdateProfile={onUpdateProfile}
                        onClose={() => setShowFaceManage(false)}
                        onReUpload={(type) => {
                            setShowFaceManage(false);
                            setShowFaceUpload(true);
                        }}
                    />
                </Suspense>

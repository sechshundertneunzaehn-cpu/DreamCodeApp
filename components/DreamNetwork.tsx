...
const TRANSLATIONS: Record<string, {
    ...
    zh: {
        ...
        most_common: '最常见',
        times: '次',
        community_soon: '社区：谁做了类似的梦？',
        community_desc: '即将推出',
        no_data: '暂无梦境',
        no_data_desc: '记录你的第一个梦来查看网络。',
        categories: {
            water: '水', flying: '飞行', falling: '坠落', animals: '动物',
            fear: '恐惧', spiritual: '灵性', death: '死亡', love: '爱情',
            chase: '追逐', house: '房屋',
        },
    },
    hi: {
        title: 'स्वप्न नेटवर्क',
        subtitle: 'आपके सपनों के विषय एक नज़र में',
        your_dreams: 'आपके सपने',
        most_common: 'सबसे आम',
        times: 'बार',
        community_soon: 'समुदाय: कौन इसी तरह के सपने देखता है?',
        community_desc: 'जल्द आ रहा है',
        no_data: 'अभी कोई सपने नहीं',
        no_data_desc: 'नेटवर्क देखने के लिए अपना पहला सपना दर्ज करें।',
        categories: {
            water: 'पानी', flying: 'उड़ना', falling: 'गिरना', animals: 'जानवर',
            fear: 'डर', spiritual: 'आध्यात्मिक', death: 'मृत्यु', love: 'प्रेम',
            chase: 'पीछा', house: 'घर',
        },
    },
    ja: {
        title: '夢ネットワーク',
        subtitle: 'あなたの夢のテーマを一覧で',
        your_dreams: 'あなたの夢',
        most_common: '最も多い',
        times: '回',
        community_soon: 'コミュニティ：似た夢を見る人は？',
        community_desc: '近日公開',
        no_data: 'まだ夢がありません',
        no_data_desc: 'ネットワークを表示するには最初の夢を記録してください。',
        categories: {
            water: '水', flying: '飛行', falling: '落下', animals: '動物',
            fear: '恐怖', spiritual: 'スピリチュアル', death: '死', love: '愛',
            chase: '追跡', house: '家',
        },
    },
    ko: {
        ...
        most_common: '가장 많은',
        times: '회',
        community_soon: '커뮤니티: 비슷한 꿈을 꾸는 사람은?',
        community_desc: '곧 출시',
        no_data: '아직 꿈이 없습니다',
        no_data_desc: '네트워크를 보려면 첫 번째 꿈을 기록하세요.',
        categories: {
            water: '물', flying: '비행', falling: '추락', animals: '동물',
            fear: '공포', spiritual: '영적', death: '죽음', love: '사랑',
            chase: '추격', house: '집',
        },
    },
    id: {
        title: 'Jaringan Mimpi',
        subtitle: 'Tema mimpimu sekilas pandang',
        your_dreams: 'Mimpimu',
        most_common: 'Paling sering',
        times: 'x',
        community_soon: 'Komunitas: Siapa yang bermimpi serupa?',
        community_desc: 'Segera hadir',
        no_data: 'Belum ada mimpi',
        no_data_desc: 'Catat mimpi pertamamu untuk melihat jaringan.',
        categories: {
            water: 'Air', flying: 'Terbang', falling: 'Jatuh', animals: 'Hewan',
            fear: 'Ketakutan', spiritual: 'Spiritual', death: 'Kematian', love: 'Cinta',
            chase: 'Pengejaran', house: 'Rumah',
        },
    },
    fa: {
        title: 'شبکه رویاها',
        subtitle: 'موضوعات رویاهای شما در یک نگاه',
        your_dreams: 'رویاهای شما',
        most_common: 'رایج‌ترین',
        times: 'بار',
        community_soon: 'جامعه: چه کسی خواب‌های مشابه می‌بیند؟',
        community_desc: 'به‌زودی',
        no_data: 'هنوز رویایی نیست',
        no_data_desc: 'اولین رویای خود را ثبت کنید تا شبکه را ببینید.',
        categories: {
            water: 'آب', flying: 'پرواز', falling: 'سقوط', animals: 'حیوانات',
            fear: 'ترس', spiritual: 'معنوی', death: 'مرگ', love: 'عشق',
            chase: 'تعقیب', house: 'خانه',
        },
    },
    it: {
        title: 'Rete dei Sogni',
        subtitle: 'I tuoi temi onirici a colpo d\'occhio',
        your_dreams: 'I tuoi sogni',
        most_common: 'Più frequente',
        times: 'x',
        community_soon: 'Comunità: Chi sogna in modo simile?',
        community_desc: 'Prossimamente',
        no_data: 'Nessun sogno ancora',
        no_data_desc: 'Registra il tuo primo sogno per vedere la rete.',
        categories: {
            water: 'Acqua', flying: 'Volare', falling: 'Cadere', animals: 'Animali',
            fear: 'Paura', spiritual: 'Spirituale', death: 'Morte', love: 'Amore',
            chase: 'Inseguimento', house: 'Casa',
        },
    },
    pl: {
        title: 'Sieć Snów',
        subtitle: 'Twoje motywy snów w jednym miejscu',
        your_dreams: 'Twoje sny',
        most_common: 'Najczęstszy',
        times: 'x',
        community_soon: 'Społeczność: Kto śni podobnie?',
        community_desc: 'Wkrótce',
        no_data: 'Brak snów',
        no_data_desc: 'Zapisz swój pierwszy sen, aby zobaczyć sieć.',
        categories: {
            water: 'Woda', flying: 'Latanie', falling: 'Spadanie', animals: 'Zwierzęta',
            fear: 'Strach', spiritual: 'Duchowy', death: 'Śmierć', love: 'Miłość',
            chase: 'Pościg', house: 'Dom',
        },
    },
    bn: {
        title: 'স্বপ্ন নেটওয়ার্ক',
        subtitle: 'আপনার স্বপ্নের বিষয়গুলো এক নজরে',
        your_dreams: 'আপনার স্বপ্ন',
        most_common: 'সবচেয়ে সাধারণ',
        times: 'বার',
        community_soon: 'কমিউনিটি: কে একই রকম স্বপ্ন দেখে?',
        community_desc: 'শীঘ্রই আসছে',
        no_data: 'এখনো কোনো স্বপ্ন নেই',
        no_data_desc: 'নেটওয়ার্ক দেখতে আপনার প্রথম স্বপ্ন রেকর্ড করুন।',
        categories: {
            water: 'জল', flying: 'উড়া', falling: 'পড়া', animals: 'প্রাণী',
            fear: 'ভয়', spiritual: 'আধ্যাত্মিক', death: 'মৃত্যু', love: 'ভালোবাসা',
            chase: 'ধাওয়া', house: 'ঘর',
        },
    },
    ur: {
        title: 'خوابوں کا نیٹ ورک',
        subtitle: 'آپ کے خوابوں کے موضوعات ایک نظر میں',
        your_dreams: 'آپ کے خواب',
        most_common: 'سب سے عام',
        times: 'بار',
        community_soon: 'کمیونٹی: کون ملتے جلتے خواب دیکھتا ہے؟',
        community_desc: 'جلد آ رہا ہے',
        no_data: 'ابھی کوئی خواب نہیں',
        no_data_desc: 'نیٹ ورک دیکھنے کے لیے اپنا پہلا خواب ریکارڈ کریں۔',
        categories: {
            water: 'پانی', flying: 'اُڑان', falling: 'گرنا', animals: 'جانور',
            fear: 'خوف', spiritual: 'روحانی', death: 'موت', love: 'محبت',
            chase: 'تعاقب', house: 'گھر',
        },
    },
    vi: {
        title: 'Mạng lưới Giấc mơ',
        subtitle: 'Chủ đề giấc mơ của bạn trong nháy mắt',
        your_dreams: 'Giấc mơ của bạn',
        most_common: 'Thường gặp nhất',
        times: 'lần',
        community_soon: 'Cộng đồng: Ai mơ giống bạn?',
        community_desc: 'Sắp ra mắt',
        no_data: 'Chưa có giấc mơ nào',
        no_data_desc: 'Ghi lại giấc mơ đầu tiên để xem mạng lưới.',
        categories: {
            water: 'Nước', flying: 'Bay', falling: 'Rơi', animals: 'Động vật',
            fear: 'Sợ hãi', spiritual: 'Tâm linh', death: 'Cái chết', love: 'Tình yêu',
            chase: 'Rượt đuổi', house: 'Ngôi nhà',
        },
    },
    th: {
        title: 'เครือข่ายความฝัน',
        subtitle: 'ธีมความฝันของคุณในภาพรวม',
        your_dreams: 'ความฝันของคุณ',
        most_common: 'พบบ่อยที่สุด',
        times: 'ครั้ง',
        community_soon: 'ชุมชน: ใครฝันคล้ายกัน?',
        community_desc: 'เร็วๆ นี้',
        no_data: 'ยังไม่มีความฝัน',
        no_data_desc: 'บันทึกความฝันแรกของคุณเพื่อดูเครือข่าย',
        categories: {
            water: 'น้ำ', flying: 'บิน', falling: 'ตก', animals: 'สัตว์',
            fear: 'ความกลัว', spiritual: 'จิตวิญญาณ', death: 'ความตาย', love: 'ความรัก',
            chase: 'ไล่ล่า', house: 'บ้าน',
        },
    },
    sw: {
        title: 'Mtandao wa Ndoto',
        subtitle: 'Mada za ndoto zako kwa mtazamo mmoja',
        your_dreams: 'Ndoto zako',
        most_common: 'Ya mara kwa mara',
        times: 'x',
        community_soon: 'Jumuiya: Nani anaota sawa?',
        community_desc: 'Inakuja hivi karibuni',
        no_data: 'Hakuna ndoto bado',
        no_data_desc: 'Rekodi ndoto yako ya kwanza kuona mtandao.',
        categories: {
            water: 'Maji', flying: 'Kuruka', falling: 'Kuanguka', animals: 'Wanyama',
            fear: 'Hofu', spiritual: 'Kiroho', death: 'Kifo', love: 'Upendo',
            chase: 'Kufuatilia', house: 'Nyumba',
        },
    },
    hu: {
        title: 'Álomhálózat',
        subtitle: 'Álomtémáid egy pillantásra',
        your_dreams: 'Álmaid',
        most_common: 'Leggyakoribb',
        times: 'x',
        community_soon: 'Közösség: Ki álmodik hasonlót?',
        community_desc: 'Hamarosan',
        no_data: 'Még nincsenek álmok',
        no_data_desc: 'Rögzítsd az első álmod a hálózat megjelenítéséhez.',
        categories: {
            water: 'Víz', flying: 'Repülés', falling: 'Zuhanás', animals: 'Állatok',
            fear: 'Félelem', spiritual: 'Spirituális', death: 'Halál', love: 'Szerelem',
            chase: 'Üldözés', house: 'Ház',
        },
    },
};

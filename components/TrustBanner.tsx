...
const TRUST_TRANSLATIONS: Record<Language, { text: string; sources: string[] }> = {
  [Language.DE]: {
    text: 'Basierend auf 64.500+ wissenschaftlichen Traumberichten aus 3 Forschungsdatenbanken',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.EN]: {
    text: 'Based on 64,500+ scientific dream reports from 3 research databases',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.TR]: {
    text: '3 araştırma veri tabanından 64.500+ bilimsel rüya raporuna dayanmaktadır',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.ES]: {
    text: 'Basado en 64.500+ informes científicos de sueños de 3 bases de datos de investigación',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.FR]: {
    text: 'Basé sur 64 500+ rapports scientifiques de rêves issus de 3 bases de données',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.AR]: {
    text: 'يستند إلى أكثر من 64,500 تقرير علمي للأحلام من 3 قواعد بيانات بحثية',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.PT]: {
    text: 'Baseado em 64.500+ relatórios científicos de sonhos de 3 bases de dados de pesquisa',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
  [Language.RU]: {
    text: 'Основано на 64 500+ научных отчётах о снах из 3 исследовательских баз данных',
    sources: ['SDDb', 'DreamBank', 'Monash'],
  },
};

...
const TRANSLATIONS: Record<Language, { app_title: string, app_subtitle: string, categories: Record<ReligiousCategory, string>, sources: Record<ReligiousSource, string>, source_subtitles: Record<ReligiousSource, string>, ui: any, processing: any, sub: any, earn: any, shop: any, smart_guide: any }> = {
    ...
    [Language.ZH]: {
        ...
        sources: {
            [ReligiousSource.TIBETAN]: '藏传', [ReligiousSource.IBN_SIRIN]: 'Ibn Sirin', [ReligiousSource.NABULSI]: 'Al-Nabulsi', [ReligiousSource.AL_ISKHAFI]: 'Al-Iskhafi', [ReligiousSource.MEDIEVAL]: '中世纪', [ReligiousSource.MODERN_THEOLOGY]: '现代神学', [ReligiousSource.CHURCH_FATHERS]: '教父', [ReligiousSource.ZEN]: '禅宗', [ReligiousSource.THERAVADA]: '上座部', [ReligiousSource.FREUDIAN]: 'Freud', [ReligiousSource.JUNGIAN]: 'Jung', [ReligiousSource.GESTALT]: 'Gestalt', [ReligiousSource.WESTERN_ZODIAC]: '西方星座', [ReligiousSource.VEDIC_ASTROLOGY]: '吠陀', [ReligiousSource.CHINESE_ZODIAC]: '中国生肖', [ReligiousSource.PYTHAGOREAN]: '毕达哥拉斯', [ReligiousSource.CHALDEAN]: '迦勒底', [ReligiousSource.KABBALAH_NUMEROLOGY]: '卡巴拉', [ReligiousSource.ISLAMIC_NUMEROLOGY]: 'Abjad', [ReligiousSource.VEDIC_NUMEROLOGY]: '吠陀数字', [ReligiousSource.IMAM_SADIQ]: 'Imam Sadiq', [ReligiousSource.ISLAMSKI_SONNIK]: '伊斯兰梦书', [ReligiousSource.ZHOU_GONG]: '周公', [ReligiousSource.HATSUYUME]: '初梦', [ReligiousSource.SWAPNA_SHASTRA]: 'Swapna Shastra', [ReligiousSource.EDGAR_CAYCE]: 'Edgar Cayce', [ReligiousSource.RUDOLF_STEINER]: 'Rudolf Steiner', [ReligiousSource.TALMUD_BERAKHOT]: 'Talmud Berakhot', [ReligiousSource.ZOHAR]: 'Zohar', [ReligiousSource.VANGA]: 'Vanga', [ReligiousSource.MILLER_RU]: 'Miller', [ReligiousSource.FREUD_RU]: 'Freud (RU)', [ReligiousSource.LOFF]: 'Loff', [ReligiousSource.NOSTRADAMUS_RU]: 'Nostradamus', [ReligiousSource.ARTEMIDOROS]: 'Artemidorus', [ReligiousSource.EGYPTIAN_PAPYRUS]: '埃及纸莎草', [ReligiousSource.SOMNIALE_DANIELIS]: 'Somniale Danielis'
        },
        ui: {
    ...
    [Language.FA]: {
        ...
        sources: {
            [ReligiousSource.TIBETAN]: 'تبتی', [ReligiousSource.IBN_SIRIN]: 'Ibn Sirin', [ReligiousSource.NABULSI]: 'Al-Nabulsi', [ReligiousSource.AL_ISKHAFI]: 'Al-Iskhafi', [ReligiousSource.MEDIEVAL]: 'قرون وسطی', [ReligiousSource.MODERN_THEOLOGY]: 'الهیات مدرن', [ReligiousSource.CHURCH_FATHERS]: 'آبای کلیسا', [ReligiousSource.ZEN]: 'ذن', [ReligiousSource.THERAVADA]: 'تراوادا', [ReligiousSource.FREUDIAN]: 'Freud', [ReligiousSource.JUNGIAN]: 'Jung', [ReligiousSource.GESTALT]: 'Gestalt', [ReligiousSource.WESTERN_ZODIAC]: 'زودیاک غربی', [ReligiousSource.VEDIC_ASTROLOGY]: 'ودایی', [ReligiousSource.CHINESE_ZODIAC]: 'زودیاک چینی', [ReligiousSource.PYTHAGOREAN]: 'فیثاغورثی', [ReligiousSource.CHALDEAN]: 'کلدانی', [ReligiousSource.KABBALAH_NUMEROLOGY]: 'کابالا', [ReligiousSource.ISLAMIC_NUMEROLOGY]: 'ابجد', [ReligiousSource.VEDIC_NUMEROLOGY]: 'اعداد ودایی', [ReligiousSource.IMAM_SADIQ]: 'Imam Sadiq', [ReligiousSource.ISLAMSKI_SONNIK]: 'سنّیک اسلامی', [ReligiousSource.ZHOU_GONG]: 'Zhou Gong', [ReligiousSource.HATSUYUME]: 'Hatsuyume', [ReligiousSource.SWAPNA_SHASTRA]: 'Swapna Shastra', [ReligiousSource.EDGAR_CAYCE]: 'Edgar Cayce', [ReligiousSource.RUDOLF_STEINER]: 'Rudolf Steiner', [ReligiousSource.TALMUD_BERAKHOT]: 'Talmud Berakhot', [ReligiousSource.ZOHAR]: 'Zohar', [ReligiousSource.VANGA]: 'Vanga', [ReligiousSource.MILLER_RU]: 'Miller', [ReligiousSource.FREUD_RU]: 'Freud (RU)', [ReligiousSource.LOFF]: 'Loff', [ReligiousSource.NOSTRADAMUS_RU]: 'Nostradamus', [ReligiousSource.ARTEMIDOROS]: 'Artemidorus', [ReligiousSource.EGYPTIAN_PAPYRUS]: 'پاپیروس مصری', [ReligiousSource.SOMNIALE_DANIELIS]: 'Somniale Danielis'
        },
        ui: {
    ...
    [Language.BN]: {
        ...
        sources: {
            [ReligiousSource.TIBETAN]: 'তিব্বতীয়', [ReligiousSource.IBN_SIRIN]: 'Ibn Sirin', [ReligiousSource.NABULSI]: 'Al-Nabulsi', [ReligiousSource.AL_ISKHAFI]: 'Al-Iskhafi', [ReligiousSource.MEDIEVAL]: 'মধ্যযুগীয়', [ReligiousSource.MODERN_THEOLOGY]: 'আধুনিক ধর্মতত্ত্ব', [ReligiousSource.CHURCH_FATHERS]: 'চার্চ পিতৃগণ', [ReligiousSource.ZEN]: 'জেন', [ReligiousSource.THERAVADA]: 'থেরবাদ', [ReligiousSource.FREUDIAN]: 'Freud', [ReligiousSource.JUNGIAN]: 'Jung', [ReligiousSource.GESTALT]: 'Gestalt', [ReligiousSource.WESTERN_ZODIAC]: 'পশ্চিমা রাশিচক্র', [ReligiousSource.VEDIC_ASTROLOGY]: 'বৈদিক', [ReligiousSource.CHINESE_ZODIAC]: 'চীনা রাশিচক্র', [ReligiousSource.PYTHAGOREAN]: 'পিথাগোরীয়', [ReligiousSource.CHALDEAN]: 'ক্যালডীয়', [ReligiousSource.KABBALAH_NUMEROLOGY]: 'কাবালা', [ReligiousSource.ISLAMIC_NUMEROLOGY]: 'আবজাদ', [ReligiousSource.VEDIC_NUMEROLOGY]: 'বৈদিক সংখ্যা', [ReligiousSource.IMAM_SADIQ]: 'Imam Sadiq', [ReligiousSource.ISLAMSKI_SONNIK]: 'ইসলামি সন্নিক', [ReligiousSource.ZHOU_GONG]: 'Zhou Gong', [ReligiousSource.HATSUYUME]: 'Hatsuyume', [ReligiousSource.SWAPNA_SHASTRA]: 'Swapna Shastra', [ReligiousSource.EDGAR_CAYCE]: 'Edgar Cayce', [ReligiousSource.RUDOLF_STEINER]: 'Rudolf Steiner', [ReligiousSource.TALMUD_BERAKHOT]: 'Talmud Berakhot', [ReligiousSource.ZOHAR]: 'Zohar', [ReligiousSource.VANGA]: 'Vanga', [ReligiousSource.MILLER_RU]: 'Miller', [ReligiousSource.FREUD_RU]: 'Freud (RU)', [ReligiousSource.LOFF]: 'Loff', [ReligiousSource.NOSTRADAMUS_RU]: 'Nostradamus', [ReligiousSource.ARTEMIDOROS]: 'Artemidorus', [ReligiousSource.EGYPTIAN_PAPYRUS]: 'মিশরীয় প্যাপিরাস', [ReligiousSource.SOMNIALE_DANIELIS]: 'Somniale Danielis'
        },
        ui: {
    ...
    [Language.UR]: {
        ...
        sources: {
            [ReligiousSource.TIBETAN]: 'تبتی', [ReligiousSource.IBN_SIRIN]: 'Ibn Sirin', [ReligiousSource.NABULSI]: 'Al-Nabulsi', [ReligiousSource.AL_ISKHAFI]: 'Al-Iskhafi', [ReligiousSource.MEDIEVAL]: 'قرون وسطائی', [ReligiousSource.MODERN_THEOLOGY]: 'جدید الٰہیات', [ReligiousSource.CHURCH_FATHERS]: 'آباءِ کلیسا', [ReligiousSource.ZEN]: 'زین', [ReligiousSource.THERAVADA]: 'تھیراوادا', [ReligiousSource.FREUDIAN]: 'Freud', [ReligiousSource.JUNGIAN]: 'Jung', [ReligiousSource.GESTALT]: 'Gestalt', [ReligiousSource.WESTERN_ZODIAC]: 'مغربی زائچہ', [ReligiousSource.VEDIC_ASTROLOGY]: 'ویدک', [ReligiousSource.CHINESE_ZODIAC]: 'چینی زائچہ', [ReligiousSource.PYTHAGOREAN]: 'فیثاغورثی', [ReligiousSource.CHALDEAN]: 'کلدانی', [ReligiousSource.KABBALAH_NUMEROLOGY]: 'قبالہ', [ReligiousSource.ISLAMIC_NUMEROLOGY]: 'ابجد', [ReligiousSource.VEDIC_NUMEROLOGY]: 'ویدک اعداد', [ReligiousSource.IMAM_SADIQ]: 'Imam Sadiq', [ReligiousSource.ISLAMSKI_SONNIK]: 'اسلامی سنّک', [ReligiousSource.ZHOU_GONG]: 'Zhou Gong', [ReligiousSource.HATSUYUME]: 'Hatsuyume', [ReligiousSource.SWAPNA_SHASTRA]: 'Swapna Shastra', [ReligiousSource.EDGAR_CAYCE]: 'Edgar Cayce', [ReligiousSource.RUDOLF_STEINER]: 'Rudolf Steiner', [ReligiousSource.TALMUD_BERAKHOT]: 'Talmud Berakhot', [ReligiousSource.ZOHAR]: 'Zohar', [ReligiousSource.VANGA]: 'Vanga', [ReligiousSource.MILLER_RU]: 'Miller', [ReligiousSource.FREUD_RU]: 'Freud (RU)', [ReligiousSource.LOFF]: 'Loff', [ReligiousSource.NOSTRADAMUS_RU]: 'Nostradamus', [ReligiousSource.ARTEMIDOROS]: 'Artemidorus', [ReligiousSource.EGYPTIAN_PAPYRUS]: 'مصری پیپرس', [ReligiousSource.SOMNIALE_DANIELIS]: 'Somniale Danielis'
        },
        ui: {
